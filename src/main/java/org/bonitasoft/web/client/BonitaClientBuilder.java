...
public interface BonitaClientBuilder<T extends BonitaClientBuilder> {
	...
	/**
	 * Set the underlying OkHttp client to use. If none specified, default internal OkHttp
	 * client will be used.
	 * @param okHttpClient
	 * @return the current builder
	 */
	...
	/**
	 * Set the underlying ObjectMapper client to use. If none specified, default internal
	 * ObjectMapper client will be used.
	 * @param objectMapper
	 * @return the current builder
	 */
