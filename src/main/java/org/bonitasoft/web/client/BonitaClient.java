...
public interface BonitaClient extends ApiProvider {
	...
	/**
	 * Perform client authentication. Authentication will be stored internally to be used
	 * for the future requests <br>
	 * Account tenant default to 1
	 * @param username Account username
	 * @param password Account password
	 * @return A session with the authenticated user info
	 * @throws org.bonitasoft.web.client.exception.UnauthorizedException if authentication
	 * failed
	 */
