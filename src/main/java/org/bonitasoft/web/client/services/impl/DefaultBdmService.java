...
public class DefaultBdmService extends AbstractService implements BdmService {
	...
	public void importBDM(File bdm) {
		...
		tenantApi.updateSystemTenant(BonitaClient.DEFAULT_TENANT_ID, new TenantPauseRequest().paused("true"));
		...
		tenantApi.updateSystemTenant(BonitaClient.DEFAULT_TENANT_ID, new TenantPauseRequest().paused("false"));
