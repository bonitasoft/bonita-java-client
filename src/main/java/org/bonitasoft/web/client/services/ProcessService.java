...
public interface ProcessService {
	...
	/**
	 * @param file
	 * @param policy throws DuplicatedProcessException : if policy is set to
	 * {@link ProcessImportPolicy#FAIL_ON_DUPLICATES}
	 */
	 ...
	 * @param taskId
	 * @return
	 * @throws org.bonitasoft.web.client.exception.NotFoundException if no UserTask for
	 * the given id
	 */
