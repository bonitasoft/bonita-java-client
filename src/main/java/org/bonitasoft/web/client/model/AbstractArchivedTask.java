...
@JsonPropertyOrder({ AbstractArchivedTask.JSON_PROPERTY_ID, AbstractArchivedTask.JSON_PROPERTY_TYPE,
		AbstractArchivedTask.JSON_PROPERTY_NAME, AbstractArchivedTask.JSON_PROPERTY_DISPLAY_NAME,
		AbstractArchivedTask.JSON_PROPERTY_DESCRIPTION, AbstractArchivedTask.JSON_PROPERTY_DISPLAY_DESCRIPTION,
		AbstractArchivedTask.JSON_PROPERTY_STATE, AbstractArchivedTask.JSON_PROPERTY_REACHED_STATE_DATE,
		AbstractArchivedTask.JSON_PROPERTY_LAST_UPDATE_DATE, AbstractArchivedTask.JSON_PROPERTY_DUE_DATE,
		AbstractArchivedTask.JSON_PROPERTY_PRIORITY, AbstractArchivedTask.JSON_PROPERTY_PROCESS_ID,
		AbstractArchivedTask.JSON_PROPERTY_PARENT_CASE_ID, AbstractArchivedTask.JSON_PROPERTY_PARENT_TASK_ID,
		AbstractArchivedTask.JSON_PROPERTY_ROOT_CASE_ID, AbstractArchivedTask.JSON_PROPERTY_ROOT_CONTAINER_ID,
		AbstractArchivedTask.JSON_PROPERTY_EXECUTED_BY, AbstractArchivedTask.JSON_PROPERTY_EXECUTED_BY_SUBSTITUTE,
		AbstractArchivedTask.JSON_PROPERTY_ACTOR_ID, AbstractArchivedTask.JSON_PROPERTY_ASSIGNED_ID,
		AbstractArchivedTask.JSON_PROPERTY_ASSIGNED_DATE, AbstractArchivedTask.JSON_PROPERTY_IS_TERMINAL,
		AbstractArchivedTask.JSON_PROPERTY_ARCHIVED_DATE })
@JsonTypeName("AbstractArchivedTask")
...
public class AbstractArchivedTask implements Serializable {
	...
	public boolean equals(Object o) {
		...
		return Objects.equals(this.id, abstractArchivedTask.id) && Objects.equals(this.type, abstractArchivedTask.type)
