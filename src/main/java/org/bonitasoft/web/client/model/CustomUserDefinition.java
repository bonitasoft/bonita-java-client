...
public class CustomUserDefinition implements Serializable {
    ...
    public CustomUserDefinition id(@jakarta.annotation.Nullable String id) {
    ...
    public CustomUserDefinition description(@jakarta.annotation.Nullable String description) {
    ...
    public CustomUserDefinition name(@jakarta.annotation.Nullable String name) {
