...
@JsonPropertyOrder({ Group.JSON_PROPERTY_ID, Group.JSON_PROPERTY_NAME, Group.JSON_PROPERTY_DISPLAY_NAME,
		Group.JSON_PROPERTY_PARENT_PATH, Group.JSON_PROPERTY_PATH, Group.JSON_PROPERTY_DESCRIPTION,
		Group.JSON_PROPERTY_CREATION_DATE, Group.JSON_PROPERTY_CREATED_BY_USER_ID, Group.JSON_PROPERTY_LAST_UPDATE_DATE,
...
public class Group implements Serializable {
	...
	/**
	 * id of the user who created the group (-1 if the group was created by the tenant
	 * admin or by an organisation import)
	 * @return createdByUserId
	 */
	@javax.annotation.Nullable
	@ApiModelProperty(
			value = "id of the user who created the group (-1 if the group was created by the tenant admin or by an organisation import)")
	...
	public boolean equals(Object o) {
		...
		return Objects.equals(this.id, group.id) && Objects.equals(this.name, group.name)
				...
				&& Objects.equals(this.parentPath, group.parentPath) && Objects.equals(this.path, group.path)
				...
				&& Objects.equals(this.lastUpdateDate, group.lastUpdateDate) && Objects.equals(this.icon, group.icon);
	}

	@Override
	public int hashCode() {
		return Objects.hash(id, name, displayName, parentPath, path, description, creationDate, createdByUserId,
				lastUpdateDate, icon);
	}
