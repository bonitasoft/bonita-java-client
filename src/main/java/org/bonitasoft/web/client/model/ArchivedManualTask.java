...
/** ArchivedManualTask */
@JsonPropertyOrder({ ArchivedManualTask.JSON_PROPERTY_ID, ArchivedManualTask.JSON_PROPERTY_TYPE,
		ArchivedManualTask.JSON_PROPERTY_NAME, ArchivedManualTask.JSON_PROPERTY_DISPLAY_NAME,
		ArchivedManualTask.JSON_PROPERTY_DESCRIPTION, ArchivedManualTask.JSON_PROPERTY_DISPLAY_DESCRIPTION,
		ArchivedManualTask.JSON_PROPERTY_STATE, ArchivedManualTask.JSON_PROPERTY_REACHED_STATE_DATE,
		ArchivedManualTask.JSON_PROPERTY_LAST_UPDATE_DATE, ArchivedManualTask.JSON_PROPERTY_DUE_DATE,
		ArchivedManualTask.JSON_PROPERTY_PRIORITY, ArchivedManualTask.JSON_PROPERTY_PROCESS_ID,
		ArchivedManualTask.JSON_PROPERTY_PARENT_CASE_ID, ArchivedManualTask.JSON_PROPERTY_PARENT_TASK_ID,
		ArchivedManualTask.JSON_PROPERTY_ROOT_CASE_ID, ArchivedManualTask.JSON_PROPERTY_ROOT_CONTAINER_ID,
		ArchivedManualTask.JSON_PROPERTY_EXECUTED_BY, ArchivedManualTask.JSON_PROPERTY_EXECUTED_BY_SUBSTITUTE,
		ArchivedManualTask.JSON_PROPERTY_ACTOR_ID, ArchivedManualTask.JSON_PROPERTY_ASSIGNED_ID,
		ArchivedManualTask.JSON_PROPERTY_ASSIGNED_DATE, ArchivedManualTask.JSON_PROPERTY_IS_TERMINAL,
		ArchivedManualTask.JSON_PROPERTY_ARCHIVED_DATE })
@JsonTypeName("ArchivedManualTask")
...
public class ArchivedManualTask implements Serializable {
	...
	public ArchivedManualTask state(StateEnum state) {
	...
	public boolean equals(Object o) {
		...
		return Objects.equals(this.id, archivedManualTask.id) && Objects.equals(this.type, archivedManualTask.type)
