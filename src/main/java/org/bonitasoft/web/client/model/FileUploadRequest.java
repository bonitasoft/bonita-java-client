...
/** The file to upload */
@ApiModel(description = "The file to upload")
@JsonPropertyOrder({ FileUploadRequest.JSON_PROPERTY_FILE })
public class FileUploadRequest implements Serializable {
	...
	public FileUploadRequest file(File file) {
	...
	public boolean equals(java.lang.Object o) {
		...
		return Objects.equals(this.file, fileUploadRequest.file);
	}
