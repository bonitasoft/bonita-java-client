...
import org.bonitasoft.web.client.model.ProcessInstanceInfoFlowNodeStatesCountersValue;
...
public class ProcessInstanceInfo implements Serializable {
  ...
  private Map<String, ProcessInstanceInfoFlowNodeStatesCountersValue> flowNodeStatesCounters = null;
