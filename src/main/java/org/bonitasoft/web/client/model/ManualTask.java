...
@JsonPropertyOrder({ ManualTask.JSON_PROPERTY_ID, ManualTask.JSON_PROPERTY_TYPE, ManualTask.JSON_PROPERTY_NAME,
		ManualTask.JSON_PROPERTY_DISPLAY_NAME, ManualTask.JSON_PROPERTY_DESCRIPTION,
		ManualTask.JSON_PROPERTY_DISPLAY_DESCRIPTION, ManualTask.JSON_PROPERTY_STATE,
		ManualTask.JSON_PROPERTY_REACHED_STATE_DATE, ManualTask.JSON_PROPERTY_LAST_UPDATE_DATE,
		ManualTask.JSON_PROPERTY_DUE_DATE, ManualTask.JSON_PROPERTY_PRIORITY, ManualTask.JSON_PROPERTY_PROCESS_ID,
		ManualTask.JSON_PROPERTY_PARENT_CASE_ID, ManualTask.JSON_PROPERTY_PARENT_TASK_ID,
		ManualTask.JSON_PROPERTY_ROOT_CASE_ID, ManualTask.JSON_PROPERTY_ROOT_CONTAINER_ID,
		ManualTask.JSON_PROPERTY_EXECUTED_BY, ManualTask.JSON_PROPERTY_EXECUTED_BY_SUBSTITUTE,
		ManualTask.JSON_PROPERTY_ACTOR_ID, ManualTask.JSON_PROPERTY_ASSIGNED_ID, ManualTask.JSON_PROPERTY_ASSIGNED_DATE,
...
public class ManualTask implements Serializable {
	...
	public boolean equals(Object o) {
		...
		return Objects.equals(this.id, manualTask.id) && Objects.equals(this.type, manualTask.type)
