...
/** ArchivedHumanTask */
@JsonPropertyOrder({ ArchivedHumanTask.JSON_PROPERTY_ID, ArchivedHumanTask.JSON_PROPERTY_TYPE,
		ArchivedHumanTask.JSON_PROPERTY_NAME, ArchivedHumanTask.JSON_PROPERTY_DISPLAY_NAME,
		ArchivedHumanTask.JSON_PROPERTY_DESCRIPTION, ArchivedHumanTask.JSON_PROPERTY_DISPLAY_DESCRIPTION,
		ArchivedHumanTask.JSON_PROPERTY_STATE, ArchivedHumanTask.JSON_PROPERTY_REACHED_STATE_DATE,
		ArchivedHumanTask.JSON_PROPERTY_LAST_UPDATE_DATE, ArchivedHumanTask.JSON_PROPERTY_DUE_DATE,
		ArchivedHumanTask.JSON_PROPERTY_PRIORITY, ArchivedHumanTask.JSON_PROPERTY_PROCESS_ID,
		ArchivedHumanTask.JSON_PROPERTY_PARENT_CASE_ID, ArchivedHumanTask.JSON_PROPERTY_PARENT_TASK_ID,
		ArchivedHumanTask.JSON_PROPERTY_ROOT_CASE_ID, ArchivedHumanTask.JSON_PROPERTY_ROOT_CONTAINER_ID,
		ArchivedHumanTask.JSON_PROPERTY_EXECUTED_BY, ArchivedHumanTask.JSON_PROPERTY_EXECUTED_BY_SUBSTITUTE,
		ArchivedHumanTask.JSON_PROPERTY_ACTOR_ID, ArchivedHumanTask.JSON_PROPERTY_ASSIGNED_ID,
		ArchivedHumanTask.JSON_PROPERTY_ASSIGNED_DATE, ArchivedHumanTask.JSON_PROPERTY_IS_TERMINAL,
...
public class ArchivedHumanTask implements Serializable {
	...
	public boolean equals(Object o) {
		...
		return Objects.equals(this.id, archivedHumanTask.id) && Objects.equals(this.type, archivedHumanTask.type)
	...
	public int hashCode() {
		return Objects.hash(id, type, name, displayName, description, displayDescription, state, reachedStateDate,
				...
				executedBy, executedBySubstitute, actorId, assignedId, assignedDate, isTerminal, archivedDate);
	}
