...
public class HumanTask implements Serializable {
    ...
    public HumanTask id(@jakarta.annotation.Nullable String id) {
    ...
    public HumanTask type(@jakarta.annotation.Nullable String type) {
    ...
    public HumanTask name(@jakarta.annotation.Nullable String name) {
    ...
    public HumanTask displayName(@jakarta.annotation.Nullable String displayName) {
    ...
    public HumanTask description(@jakarta.annotation.Nullable String description) {
    ...
    public HumanTask displayDescription(@jakarta.annotation.Nullable String displayDescription) {
    ...
    public HumanTask state(@jakarta.annotation.Nullable ActivityState state) {
    ...
    public HumanTask reachedStateDate(@jakarta.annotation.Nullable String reachedStateDate) {
    ...
    public HumanTask lastUpdateDate(@jakarta.annotation.Nullable String lastUpdateDate) {
    ...
    public HumanTask dueDate(@jakarta.annotation.Nullable String dueDate) {
    ...
    public HumanTask priority(@jakarta.annotation.Nullable String priority) {
    ...
    public HumanTask processId(@jakarta.annotation.Nullable String processId) {
    ...
    public HumanTask parentCaseId(@jakarta.annotation.Nullable String parentCaseId) {
    ...
    public HumanTask parentTaskId(@jakarta.annotation.Nullable String parentTaskId) {
    ...
    public HumanTask rootCaseId(@jakarta.annotation.Nullable String rootCaseId) {
    ...
    public HumanTask rootContainerId(@jakarta.annotation.Nullable String rootContainerId) {
    ...
    public HumanTask executedBy(@jakarta.annotation.Nullable String executedBy) {
    ...
    public HumanTask executedBySubstitute(@jakarta.annotation.Nullable String executedBySubstitute) {
    ...
    public HumanTask actorId(@jakarta.annotation.Nullable String actorId) {
    ...
    public HumanTask assignedId(@jakarta.annotation.Nullable String assignedId) {
    ...
    public HumanTask assignedDate(@jakarta.annotation.Nullable String assignedDate) {
    ...
    public HumanTask isTerminal(@jakarta.annotation.Nullable Boolean isTerminal) {
