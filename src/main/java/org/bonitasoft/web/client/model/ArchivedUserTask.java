...
public class ArchivedUserTask implements Serializable {
    ...
    public ArchivedUserTask id(@jakarta.annotation.Nullable String id) {
    ...
    public ArchivedUserTask type(@jakarta.annotation.Nullable String type) {
    ...
    public ArchivedUserTask name(@jakarta.annotation.Nullable String name) {
    ...
    public ArchivedUserTask displayName(@jakarta.annotation.Nullable String displayName) {
    ...
    public ArchivedUserTask description(@jakarta.annotation.Nullable String description) {
    ...
    public ArchivedUserTask displayDescription(@jakarta.annotation.Nullable String displayDescription) {
    ...
    public ArchivedUserTask state(@jakarta.annotation.Nullable ActivityState state) {
    ...
    public ArchivedUserTask reachedStateDate(@jakarta.annotation.Nullable String reachedStateDate) {
    ...
    public ArchivedUserTask lastUpdateDate(@jakarta.annotation.Nullable String lastUpdateDate) {
    ...
    public ArchivedUserTask dueDate(@jakarta.annotation.Nullable String dueDate) {
    ...
    public ArchivedUserTask priority(@jakarta.annotation.Nullable String priority) {
    ...
    public ArchivedUserTask processId(@jakarta.annotation.Nullable String processId) {
    ...
    public ArchivedUserTask parentCaseId(@jakarta.annotation.Nullable String parentCaseId) {
    ...
    public ArchivedUserTask parentTaskId(@jakarta.annotation.Nullable String parentTaskId) {
    ...
    public ArchivedUserTask rootCaseId(@jakarta.annotation.Nullable String rootCaseId) {
    ...
    public ArchivedUserTask rootContainerId(@jakarta.annotation.Nullable String rootContainerId) {
    ...
    public ArchivedUserTask executedBy(@jakarta.annotation.Nullable String executedBy) {
    ...
    public ArchivedUserTask executedBySubstitute(@jakarta.annotation.Nullable String executedBySubstitute) {
    ...
    public ArchivedUserTask actorId(@jakarta.annotation.Nullable String actorId) {
    ...
    public ArchivedUserTask assignedId(@jakarta.annotation.Nullable String assignedId) {
    ...
    public ArchivedUserTask assignedDate(@jakarta.annotation.Nullable String assignedDate) {
    ...
    public ArchivedUserTask isTerminal(@jakarta.annotation.Nullable Boolean isTerminal) {
    ...
    public ArchivedUserTask sourceObjectId(@jakarta.annotation.Nullable String sourceObjectId) {
    ...
    public ArchivedUserTask archivedDate(@jakarta.annotation.Nullable String archivedDate) {
