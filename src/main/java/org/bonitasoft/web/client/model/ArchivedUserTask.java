...
/** ArchivedUserTask */
@JsonPropertyOrder({ ArchivedUserTask.JSON_PROPERTY_ID, ArchivedUserTask.JSON_PROPERTY_TYPE,
		ArchivedUserTask.JSON_PROPERTY_NAME, ArchivedUserTask.JSON_PROPERTY_DISPLAY_NAME,
		ArchivedUserTask.JSON_PROPERTY_DESCRIPTION, ArchivedUserTask.JSON_PROPERTY_DISPLAY_DESCRIPTION,
		ArchivedUserTask.JSON_PROPERTY_STATE, ArchivedUserTask.JSON_PROPERTY_REACHED_STATE_DATE,
		ArchivedUserTask.JSON_PROPERTY_LAST_UPDATE_DATE, ArchivedUserTask.JSON_PROPERTY_DUE_DATE,
		ArchivedUserTask.JSON_PROPERTY_PRIORITY, ArchivedUserTask.JSON_PROPERTY_PROCESS_ID,
		ArchivedUserTask.JSON_PROPERTY_PARENT_CASE_ID, ArchivedUserTask.JSON_PROPERTY_PARENT_TASK_ID,
		ArchivedUserTask.JSON_PROPERTY_ROOT_CASE_ID, ArchivedUserTask.JSON_PROPERTY_ROOT_CONTAINER_ID,
		ArchivedUserTask.JSON_PROPERTY_EXECUTED_BY, ArchivedUserTask.JSON_PROPERTY_EXECUTED_BY_SUBSTITUTE,
		ArchivedUserTask.JSON_PROPERTY_ACTOR_ID, ArchivedUserTask.JSON_PROPERTY_ASSIGNED_ID,
		ArchivedUserTask.JSON_PROPERTY_ASSIGNED_DATE, ArchivedUserTask.JSON_PROPERTY_IS_TERMINAL,
...
public class ArchivedUserTask implements Serializable {
	...
	public boolean equals(Object o) {
		...
		return Objects.equals(this.id, archivedUserTask.id) && Objects.equals(this.type, archivedUserTask.type)
