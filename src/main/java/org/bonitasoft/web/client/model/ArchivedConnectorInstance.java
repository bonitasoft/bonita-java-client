...
import org.bonitasoft.web.client.model.ArchivedConnectorInstanceAllOf;
...
public class ArchivedConnectorInstance implements Serializable {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(containerType, connectorId, id, name, activationEvent, state, containerId, version, archivedDate);
  }
