...
/**
 * This resource enables you to retrieve the value of a specific variable name for a specific
 * process instance (or case). Only persistent variables are concerned by this resource, not
 * transient variables.
 */
@ApiModel(description = "This resource enables you to retrieve the value of a specific variable name for a specific process instance (or case). Only persistent variables are concerned by this resource, not transient variables.")
@JsonPropertyOrder({
...
public class ActivityVariable implements Serializable {
    ...
    /**
     * ACTIVITY_INSTANCE | PROCESS_INSTANCE depending on whether the variable is defined at activity
     * or process level.
     */
    ...
    /**
     * The ID of the activity containing this variable (same as the one passed as parameter) if the
     * variable is defined at activity level or ID of the process instance if the variable is defined
     * on the process
     *
     * @return containerId
     */
