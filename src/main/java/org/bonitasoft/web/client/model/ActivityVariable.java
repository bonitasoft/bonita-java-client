 ...
 * specific process instance (or case). Only persistent variables are concerned by this
 * resource, not transient variables.
 */
@ApiModel(
...
@JsonPropertyOrder({ ActivityVariable.JSON_PROPERTY_TENANT_ID, ActivityVariable.JSON_PROPERTY_TENANT_ID_STRING,
		ActivityVariable.JSON_PROPERTY_ID, ActivityVariable.JSON_PROPERTY_ID_STRING,
		ActivityVariable.JSON_PROPERTY_NAME, ActivityVariable.JSON_PROPERTY_DESCRIPTION,
		ActivityVariable.JSON_PROPERTY_TRANSIENT_DATA, ActivityVariable.JSON_PROPERTY_CLASS_NAME,
		ActivityVariable.JSON_PROPERTY_CONTAINER_ID, ActivityVariable.JSON_PROPERTY_CONTAINER_ID_STRING,
		ActivityVariable.JSON_PROPERTY_CONTAINER_TYPE, ActivityVariable.JSON_PROPERTY_VALUE })
...
public class ActivityVariable implements Serializable {
	...
	/**
	 * The ID of the activity containing this variable (same as the one passed as
	 * parameter) if the variable is defined at activity level or ID of the process
	 * instance if the variable is defined on the process
	 * @return containerId
	 */
	@javax.annotation.Nullable
	@ApiModelProperty(
			value = "The ID of the activity containing this variable (same as the one passed as parameter) if the variable is defined at activity level or ID of the process instance if the variable is defined on the process")
	...
	@javax.annotation.Nullable
	@ApiModelProperty(
			value = "ACTIVITY_INSTANCE | PROCESS_INSTANCE depending on whether the variable is defined at activity or process level.")
	...
	/**
	 * the value of this variable. The format of the value depends on the type of the
	 * variable
	 * @return value
	 */
	@javax.annotation.Nullable
