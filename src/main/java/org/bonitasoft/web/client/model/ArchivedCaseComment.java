...
import org.bonitasoft.web.client.model.ArchivedCaseCommentAllOf;
 ...
 */
@JsonPropertyOrder({
  ArchivedCaseComment.JSON_PROPERTY_ID,
  ArchivedCaseComment.JSON_PROPERTY_CONTENT,
  ArchivedCaseComment.JSON_PROPERTY_TENANT_ID,
  ArchivedCaseComment.JSON_PROPERTY_PROCESS_INSTANCE_ID,
  ArchivedCaseComment.JSON_PROPERTY_POST_DATE,
...
public class ArchivedCaseComment implements Serializable {
  ...
  public ArchivedCaseComment id(String id) {
  ...
  **/
  ...
  public ArchivedCaseComment content(String content) {
  ...
  **/
  ...
  public ArchivedCaseComment tenantId(String tenantId) {
  ...
  **/
  ...
  public ArchivedCaseComment processInstanceId(String processInstanceId) {
  ...
  **/
  ...
  public ArchivedCaseComment postDate(String postDate) {
  ...
  **/
  ...
  public ArchivedCaseComment userId(String userId) {
  ...
  **/
  ...
  public ArchivedCaseComment archivedDate(String archivedDate) {
   ...
   /**
   * the date set when the case comment was archived
   * @return archivedDate
  **/
  @javax.annotation.Nullable
  ...
  public boolean equals(java.lang.Object o) {
    ...
    ArchivedCaseComment archivedCaseComment = (ArchivedCaseComment) o;
    return Objects.equals(this.id, archivedCaseComment.id) &&
        Objects.equals(this.content, archivedCaseComment.content) &&
        Objects.equals(this.tenantId, archivedCaseComment.tenantId) &&
        Objects.equals(this.processInstanceId, archivedCaseComment.processInstanceId) &&
        Objects.equals(this.postDate, archivedCaseComment.postDate) &&
        Objects.equals(this.userId, archivedCaseComment.userId) &&
        Objects.equals(this.archivedDate, archivedCaseComment.archivedDate);
  }
  ...
  public String toString() {
    ...
    sb.append("class ArchivedCaseComment {\n");
