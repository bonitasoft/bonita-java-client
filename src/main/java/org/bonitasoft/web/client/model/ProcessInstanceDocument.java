...
@JsonPropertyOrder({ ProcessInstanceDocument.JSON_PROPERTY_ID, ProcessInstanceDocument.JSON_PROPERTY_CREATION_DATE,
		ProcessInstanceDocument.JSON_PROPERTY_AUTHOR, ProcessInstanceDocument.JSON_PROPERTY_INDEX,
		ProcessInstanceDocument.JSON_PROPERTY_CONTENT_MIMETYPE, ProcessInstanceDocument.JSON_PROPERTY_CASE_ID,
		ProcessInstanceDocument.JSON_PROPERTY_CONTENT_STORAGE_ID, ProcessInstanceDocument.JSON_PROPERTY_IS_INTERNAL,
		ProcessInstanceDocument.JSON_PROPERTY_DESCRIPTION, ProcessInstanceDocument.JSON_PROPERTY_NAME,
		ProcessInstanceDocument.JSON_PROPERTY_FILE_NAME, ProcessInstanceDocument.JSON_PROPERTY_SUBMITTED_BY,
		ProcessInstanceDocument.JSON_PROPERTY_URL, ProcessInstanceDocument.JSON_PROPERTY_VERSION })
@JsonTypeName("ProcessInstanceDocument")
