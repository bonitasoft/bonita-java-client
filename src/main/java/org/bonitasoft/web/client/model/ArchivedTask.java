...
/** ArchivedTask */
@JsonPropertyOrder({ ArchivedTask.JSON_PROPERTY_ID, ArchivedTask.JSON_PROPERTY_TYPE, ArchivedTask.JSON_PROPERTY_NAME,
		ArchivedTask.JSON_PROPERTY_DISPLAY_NAME, ArchivedTask.JSON_PROPERTY_DESCRIPTION,
		ArchivedTask.JSON_PROPERTY_DISPLAY_DESCRIPTION, ArchivedTask.JSON_PROPERTY_STATE,
		ArchivedTask.JSON_PROPERTY_REACHED_STATE_DATE, ArchivedTask.JSON_PROPERTY_LAST_UPDATE_DATE,
		ArchivedTask.JSON_PROPERTY_DUE_DATE, ArchivedTask.JSON_PROPERTY_PRIORITY, ArchivedTask.JSON_PROPERTY_PROCESS_ID,
		ArchivedTask.JSON_PROPERTY_PARENT_CASE_ID, ArchivedTask.JSON_PROPERTY_PARENT_TASK_ID,
		ArchivedTask.JSON_PROPERTY_ROOT_CASE_ID, ArchivedTask.JSON_PROPERTY_ROOT_CONTAINER_ID,
		ArchivedTask.JSON_PROPERTY_EXECUTED_BY, ArchivedTask.JSON_PROPERTY_EXECUTED_BY_SUBSTITUTE,
		ArchivedTask.JSON_PROPERTY_ACTOR_ID, ArchivedTask.JSON_PROPERTY_ASSIGNED_ID,
		ArchivedTask.JSON_PROPERTY_ASSIGNED_DATE, ArchivedTask.JSON_PROPERTY_IS_TERMINAL,
...
public class ArchivedTask implements Serializable {
	...
	public boolean equals(Object o) {
		...
		return Objects.equals(this.id, archivedTask.id) && Objects.equals(this.type, archivedTask.type)
