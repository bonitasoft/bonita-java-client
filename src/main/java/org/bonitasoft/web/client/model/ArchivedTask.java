 ...
 */
@JsonPropertyOrder({
        ArchivedTask.JSON_PROPERTY_ID,
        ArchivedTask.JSON_PROPERTY_TYPE,
        ArchivedTask.JSON_PROPERTY_NAME,
        ArchivedTask.JSON_PROPERTY_DISPLAY_NAME,
        ArchivedTask.JSON_PROPERTY_DESCRIPTION,
        ArchivedTask.JSON_PROPERTY_DISPLAY_DESCRIPTION,
        ArchivedTask.JSON_PROPERTY_STATE,
        ArchivedTask.JSON_PROPERTY_REACHED_STATE_DATE,
        ArchivedTask.JSON_PROPERTY_LAST_UPDATE_DATE,
        ArchivedTask.JSON_PROPERTY_DUE_DATE,
        ArchivedTask.JSON_PROPERTY_PRIORITY,
        ArchivedTask.JSON_PROPERTY_PROCESS_ID,
        ArchivedTask.JSON_PROPERTY_PARENT_CASE_ID,
        ArchivedTask.JSON_PROPERTY_PARENT_TASK_ID,
        ArchivedTask.JSON_PROPERTY_ROOT_CASE_ID,
        ArchivedTask.JSON_PROPERTY_ROOT_CONTAINER_ID,
        ArchivedTask.JSON_PROPERTY_EXECUTED_BY,
        ArchivedTask.JSON_PROPERTY_EXECUTED_BY_SUBSTITUTE,
        ArchivedTask.JSON_PROPERTY_ACTOR_ID,
        ArchivedTask.JSON_PROPERTY_ASSIGNED_ID,
        ArchivedTask.JSON_PROPERTY_ASSIGNED_DATE,
        ArchivedTask.JSON_PROPERTY_IS_TERMINAL,
...
public class ArchivedTask implements Serializable {
    ...
    public ArchivedTask id(@jakarta.annotation.Nullable String id) {
    ...
    public ArchivedTask type(@jakarta.annotation.Nullable String type) {
    ...
    public ArchivedTask name(@jakarta.annotation.Nullable String name) {
    ...
    public ArchivedTask displayName(@jakarta.annotation.Nullable String displayName) {
    ...
    public ArchivedTask description(@jakarta.annotation.Nullable String description) {
    ...
    public ArchivedTask displayDescription(@jakarta.annotation.Nullable String displayDescription) {
    ...
    public ArchivedTask state(@jakarta.annotation.Nullable ActivityState state) {
    ...
    public ArchivedTask reachedStateDate(@jakarta.annotation.Nullable String reachedStateDate) {
    ...
    public ArchivedTask lastUpdateDate(@jakarta.annotation.Nullable String lastUpdateDate) {
    ...
    public ArchivedTask dueDate(@jakarta.annotation.Nullable String dueDate) {
    ...
    public ArchivedTask priority(@jakarta.annotation.Nullable String priority) {
    ...
    public ArchivedTask processId(@jakarta.annotation.Nullable String processId) {
    ...
    public ArchivedTask parentCaseId(@jakarta.annotation.Nullable String parentCaseId) {
    ...
    public ArchivedTask parentTaskId(@jakarta.annotation.Nullable String parentTaskId) {
    ...
    public ArchivedTask rootCaseId(@jakarta.annotation.Nullable String rootCaseId) {
    ...
    public ArchivedTask rootContainerId(@jakarta.annotation.Nullable String rootContainerId) {
    ...
    public ArchivedTask executedBy(@jakarta.annotation.Nullable String executedBy) {
    ...
    public ArchivedTask executedBySubstitute(@jakarta.annotation.Nullable String executedBySubstitute) {
    ...
    public ArchivedTask actorId(@jakarta.annotation.Nullable String actorId) {
    ...
    public ArchivedTask assignedId(@jakarta.annotation.Nullable String assignedId) {
    ...
    public ArchivedTask assignedDate(@jakarta.annotation.Nullable String assignedDate) {
    ...
    public ArchivedTask isTerminal(@jakarta.annotation.Nullable Boolean isTerminal) {
    ...
    public ArchivedTask sourceObjectId(@jakarta.annotation.Nullable String sourceObjectId) {
    ...
    public ArchivedTask archivedDate(@jakarta.annotation.Nullable String archivedDate) {
    ...
    public boolean equals(Object o) {
        ...
        ArchivedTask archivedTask = (ArchivedTask) o;
        return Objects.equals(this.id, archivedTask.id) &&
                Objects.equals(this.type, archivedTask.type) &&
                Objects.equals(this.name, archivedTask.name) &&
                Objects.equals(this.displayName, archivedTask.displayName) &&
                Objects.equals(this.description, archivedTask.description) &&
                Objects.equals(this.displayDescription, archivedTask.displayDescription) &&
                Objects.equals(this.state, archivedTask.state) &&
                Objects.equals(this.reachedStateDate, archivedTask.reachedStateDate) &&
                Objects.equals(this.lastUpdateDate, archivedTask.lastUpdateDate) &&
                Objects.equals(this.dueDate, archivedTask.dueDate) &&
                Objects.equals(this.priority, archivedTask.priority) &&
                Objects.equals(this.processId, archivedTask.processId) &&
                Objects.equals(this.parentCaseId, archivedTask.parentCaseId) &&
                Objects.equals(this.parentTaskId, archivedTask.parentTaskId) &&
                Objects.equals(this.rootCaseId, archivedTask.rootCaseId) &&
                Objects.equals(this.rootContainerId, archivedTask.rootContainerId) &&
                Objects.equals(this.executedBy, archivedTask.executedBy) &&
                Objects.equals(this.executedBySubstitute, archivedTask.executedBySubstitute) &&
                Objects.equals(this.actorId, archivedTask.actorId) &&
                Objects.equals(this.assignedId, archivedTask.assignedId) &&
                Objects.equals(this.assignedDate, archivedTask.assignedDate) &&
                Objects.equals(this.isTerminal, archivedTask.isTerminal) &&
                Objects.equals(this.sourceObjectId, archivedTask.sourceObjectId) &&
                Objects.equals(this.archivedDate, archivedTask.archivedDate);
    }
