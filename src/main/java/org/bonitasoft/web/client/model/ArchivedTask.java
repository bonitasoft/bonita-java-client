...
public class ArchivedTask implements Serializable {
    ...
    public ArchivedTask id(String id) {
    ...
    public ArchivedTask type(String type) {
    ...
    public ArchivedTask name(String name) {
    ...
    public ArchivedTask displayName(String displayName) {
    ...
    public ArchivedTask description(String description) {
    ...
    public ArchivedTask displayDescription(String displayDescription) {
    ...
    public ArchivedTask state(ActivityState state) {
    ...
    public ArchivedTask reachedStateDate(String reachedStateDate) {
    ...
    public ArchivedTask lastUpdateDate(String lastUpdateDate) {
    ...
    public ArchivedTask dueDate(String dueDate) {
    ...
    public ArchivedTask priority(String priority) {
    ...
    public ArchivedTask processId(String processId) {
    ...
    public ArchivedTask parentCaseId(String parentCaseId) {
    ...
    public ArchivedTask parentTaskId(String parentTaskId) {
    ...
    public ArchivedTask rootCaseId(String rootCaseId) {
    ...
    public ArchivedTask rootContainerId(String rootContainerId) {
    ...
    public ArchivedTask executedBy(String executedBy) {
    ...
    public ArchivedTask executedBySubstitute(String executedBySubstitute) {
    ...
    public ArchivedTask actorId(String actorId) {
    ...
    public ArchivedTask assignedId(String assignedId) {
    ...
    public ArchivedTask assignedDate(String assignedDate) {
    ...
    public ArchivedTask isTerminal(Boolean isTerminal) {
    ...
    public ArchivedTask sourceObjectId(String sourceObjectId) {
    ...
    public ArchivedTask archivedDate(String archivedDate) {
