...
/** Task */
@JsonPropertyOrder({ Task.JSON_PROPERTY_ID, Task.JSON_PROPERTY_TYPE, Task.JSON_PROPERTY_NAME,
		Task.JSON_PROPERTY_DISPLAY_NAME, Task.JSON_PROPERTY_DESCRIPTION, Task.JSON_PROPERTY_DISPLAY_DESCRIPTION,
		Task.JSON_PROPERTY_STATE, Task.JSON_PROPERTY_REACHED_STATE_DATE, Task.JSON_PROPERTY_LAST_UPDATE_DATE,
		Task.JSON_PROPERTY_DUE_DATE, Task.JSON_PROPERTY_PRIORITY, Task.JSON_PROPERTY_PROCESS_ID,
		Task.JSON_PROPERTY_PARENT_CASE_ID, Task.JSON_PROPERTY_PARENT_TASK_ID, Task.JSON_PROPERTY_ROOT_CASE_ID,
		Task.JSON_PROPERTY_ROOT_CONTAINER_ID, Task.JSON_PROPERTY_EXECUTED_BY, Task.JSON_PROPERTY_EXECUTED_BY_SUBSTITUTE,
		Task.JSON_PROPERTY_ACTOR_ID, Task.JSON_PROPERTY_ASSIGNED_ID, Task.JSON_PROPERTY_ASSIGNED_DATE,
...
public class Task implements Serializable {
	...
	public boolean equals(Object o) {
		...
		Task task = (Task) o;
		return Objects.equals(this.id, task.id) && Objects.equals(this.type, task.type)
				&& Objects.equals(this.name, task.name) && Objects.equals(this.displayName, task.displayName)
				...
				&& Objects.equals(this.dueDate, task.dueDate) && Objects.equals(this.priority, task.priority)
				...
				&& Objects.equals(this.actorId, task.actorId) && Objects.equals(this.assignedId, task.assignedId)
