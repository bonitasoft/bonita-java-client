...
@JsonTypeName("UpdateProcessConnectorByProcessIdRequest")
...
public class UpdateProcessConnectorByProcessIdRequest implements Serializable {
  ...
  **/
  ...
  @ApiModelProperty(value = "Id of the process for which to update the connector, combined with connector name and version separated by slashes (x/y/z)")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Previously uploaded temp file name of the updated version of the connector (returned by the  [upload file api](#operation/uploadFile))")
