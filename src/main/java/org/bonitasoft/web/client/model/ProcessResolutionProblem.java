 ...
 * process to run. It can be an actor, a connector implementation, or a parameter (in the
 * Enterprise, Performance, Efficiency, or Teamwork edition).
 */
@ApiModel(
		description = "This resource represents a problem in a process that needs to be resolved for the process to run. It can be an actor, a connector implementation, or a parameter (in the Enterprise, Performance, Efficiency, or Teamwork edition).")
@JsonPropertyOrder({ ProcessResolutionProblem.JSON_PROPERTY_MESSAGE, ProcessResolutionProblem.JSON_PROPERTY_RESOURCE_ID,
		ProcessResolutionProblem.JSON_PROPERTY_TARGET_TYPE })
@JsonTypeName("ProcessResolutionProblem")
