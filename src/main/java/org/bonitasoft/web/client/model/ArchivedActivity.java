...
/**
 * Use this resource to retrieve finished activities (human or service tasks), call activities, and
 * subprocesses.
 */
@ApiModel(
    description =
...
public class ArchivedActivity implements Serializable {
  ...
  /**
   * the date (&#39;yyyy-MM-dd HH:mm:ss.SSS&#39;) when this archived activity reached the current
  ...
  /**
   * the date (&#39;yyyy-MM-dd HH:mm:ss.SSS&#39;) when this archived activity was last updated, for
  ...
  /**
   * the date (&#39;yyyy-MM-dd HH:mm:ss.SSS&#39;) when this archived activity is due, for example
  ...
  /**
   * the id of the user who performed this archived activity. The archived activity has to be a
  ...
  /**
   * the id of the user who did actually performed the archived activity when it has been done in
  ...
  @javax.annotation.Nullable
  @ApiModelProperty(
      value = "the id of the actor that can execute this archived activity, null otherwise")
  ...
  @javax.annotation.Nullable
  @ApiModelProperty(
      value = "the user id that this archived activity is assigned to, or 0 if it is unassigned")
  ...
  /**
   * the date (&#39;yyyy-MM-dd HH:mm:ss.SSS&#39;) when the current archived activity was assigned,
  ...
  /**
   * the date ((&#39;yyyy-MM-dd HH:mm:ss.SSS&#39;)) when this archived activity was archived, for
   * example &#39;2014-10-17 16:05:42.626&#39;
   *
   * @return archivedDate
   */
