...
@JsonPropertyOrder({ ArchivedActivity.JSON_PROPERTY_ID, ArchivedActivity.JSON_PROPERTY_TYPE,
		ArchivedActivity.JSON_PROPERTY_NAME, ArchivedActivity.JSON_PROPERTY_DISPLAY_NAME,
		ArchivedActivity.JSON_PROPERTY_DESCRIPTION, ArchivedActivity.JSON_PROPERTY_DISPLAY_DESCRIPTION,
		ArchivedActivity.JSON_PROPERTY_STATE, ArchivedActivity.JSON_PROPERTY_REACHED_STATE_DATE,
		ArchivedActivity.JSON_PROPERTY_LAST_UPDATE_DATE, ArchivedActivity.JSON_PROPERTY_DUE_DATE,
		ArchivedActivity.JSON_PROPERTY_PRIORITY, ArchivedActivity.JSON_PROPERTY_PROCESS_ID,
		ArchivedActivity.JSON_PROPERTY_PARENT_CASE_ID, ArchivedActivity.JSON_PROPERTY_ROOT_CASE_ID,
		ArchivedActivity.JSON_PROPERTY_ROOT_CONTAINER_ID, ArchivedActivity.JSON_PROPERTY_EXECUTED_BY,
		ArchivedActivity.JSON_PROPERTY_EXECUTED_BY_SUBSTITUTE, ArchivedActivity.JSON_PROPERTY_ACTOR_ID,
		ArchivedActivity.JSON_PROPERTY_ASSIGNED_ID, ArchivedActivity.JSON_PROPERTY_ASSIGNED_DATE,
		ArchivedActivity.JSON_PROPERTY_SOURCE_OBJECT_ID, ArchivedActivity.JSON_PROPERTY_ARCHIVED_DATE })
...
public class ArchivedActivity implements Serializable {
	...
	/**
	 * the date (&#39;yyyy-MM-dd HH:mm:ss.SSS&#39;) when this archived activity reached
	 * the current state, for example &#39;2014-10-17 16:05:42.626&#39;
	 * @return reachedStateDate
	 */
	@javax.annotation.Nullable
	@ApiModelProperty(
			value = "the date ('yyyy-MM-dd HH:mm:ss.SSS') when this archived activity reached the current state, for example '2014-10-17 16:05:42.626'")
	...
	/**
	 * the date (&#39;yyyy-MM-dd HH:mm:ss.SSS&#39;) when this archived activity was last
	 * updated, for example &#39;2014-10-17 16:05:42.626)
	 * @return lastUpdateDate
	 */
	@javax.annotation.Nullable
	@ApiModelProperty(
			value = "the date ('yyyy-MM-dd HH:mm:ss.SSS') when this archived activity was last updated, for example '2014-10-17 16:05:42.626)")
	...
	/**
	 * the date (&#39;yyyy-MM-dd HH:mm:ss.SSS&#39;) when this archived activity is due,
	 * for example &#39;2014-10-17 16:05:42.626&#39;
	 * @return dueDate
	 */
	@javax.annotation.Nullable
	@ApiModelProperty(
			value = "the date ('yyyy-MM-dd HH:mm:ss.SSS') when this archived activity is due, for example '2014-10-17 16:05:42.626'")
	...
	/**
	 * the process definition id of the process instance which define this archived
	 * activity
	 * @return processId
	 */
	@javax.annotation.Nullable
	...
	/**
	 * the top/root process instance id (a.k.a case id). In case of an \&quot;event sub
	...
	@javax.annotation.Nullable
	@ApiModelProperty(
			value = "the top/root process instance id (a.k.a case id). In case of an \"event sub process\", `parentCaseId` will the id of the process instance called while `rootCaseId` will be the one from the caller case")
	...
	/**
	 * the id of the user who performed this archived activity. The archived activity has
	 * to be a human task otherwise its value will be 0
	 * @return executedBy
	 */
	@javax.annotation.Nullable
	@ApiModelProperty(
			value = "the id of the user who performed this archived activity. The archived activity has to be a human task otherwise its value will be 0")
	...
	/**
	 * the id of the user who did actually performed the archived activity when it has
	 * been done in the name of someone else. Value is 0 otherwise
	 * @return executedBySubstitute
	 */
	@javax.annotation.Nullable
	@ApiModelProperty(
			value = "the id of the user who did actually performed the archived activity when it has been done in the name of someone else. Value is 0 otherwise")
	...
	/**
	 * the date (&#39;yyyy-MM-dd HH:mm:ss.SSS&#39;) when the current archived activity was
	 * assigned, for example &#39;2014-10-17 16:05:42.626&#39;
	 * @return assignedDate
	 */
	@javax.annotation.Nullable
	@ApiModelProperty(
			value = "the date ('yyyy-MM-dd HH:mm:ss.SSS') when the current archived activity was assigned, for example '2014-10-17 16:05:42.626'")
	 ...
	 * archived, for example &#39;2014-10-17 16:05:42.626&#39;
	 * @return archivedDate
	 */
	@javax.annotation.Nullable
	@ApiModelProperty(
			value = "the date (('yyyy-MM-dd HH:mm:ss.SSS')) when this archived activity was archived, for example '2014-10-17 16:05:42.626'")
	...
	public boolean equals(Object o) {
		...
		return Objects.equals(this.id, archivedActivity.id) && Objects.equals(this.type, archivedActivity.type)
