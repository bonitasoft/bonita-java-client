...
public class ArchivedActivity implements Serializable {
    ...
    public ArchivedActivity id(@jakarta.annotation.Nullable String id) {
    ...
    public ArchivedActivity type(@jakarta.annotation.Nullable ActivityType type) {
    ...
    public ArchivedActivity name(@jakarta.annotation.Nullable String name) {
    ...
    public ArchivedActivity displayName(@jakarta.annotation.Nullable String displayName) {
    ...
    public ArchivedActivity description(@jakarta.annotation.Nullable String description) {
    ...
    public ArchivedActivity displayDescription(@jakarta.annotation.Nullable String displayDescription) {
    ...
    public ArchivedActivity state(@jakarta.annotation.Nullable ActivityState state) {
    ...
    public ArchivedActivity reachedStateDate(@jakarta.annotation.Nullable String reachedStateDate) {
    ...
    public ArchivedActivity lastUpdateDate(@jakarta.annotation.Nullable String lastUpdateDate) {
    ...
    public ArchivedActivity dueDate(@jakarta.annotation.Nullable String dueDate) {
    ...
    public ArchivedActivity priority(@jakarta.annotation.Nullable ActivityPriority priority) {
    ...
    public ArchivedActivity processId(@jakarta.annotation.Nullable String processId) {
    ...
    public ArchivedActivity parentCaseId(@jakarta.annotation.Nullable String parentCaseId) {
    ...
    public ArchivedActivity rootCaseId(@jakarta.annotation.Nullable String rootCaseId) {
    ...
    public ArchivedActivity rootContainerId(@jakarta.annotation.Nullable String rootContainerId) {
    ...
    public ArchivedActivity executedBy(@jakarta.annotation.Nullable String executedBy) {
    ...
    public ArchivedActivity executedBySubstitute(@jakarta.annotation.Nullable String executedBySubstitute) {
    ...
    public ArchivedActivity actorId(@jakarta.annotation.Nullable String actorId) {
    ...
    public ArchivedActivity assignedId(@jakarta.annotation.Nullable String assignedId) {
    ...
    public ArchivedActivity assignedDate(@jakarta.annotation.Nullable String assignedDate) {
    ...
    public ArchivedActivity sourceObjectId(@jakarta.annotation.Nullable String sourceObjectId) {
    ...
    public ArchivedActivity archivedDate(@jakarta.annotation.Nullable String archivedDate) {
