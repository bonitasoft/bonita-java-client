...
public class BonitaLoginService implements LoginService {
  ...
  public Session login(String username, String password, String tenant) {
    ...
    final PortalAuthenticationApi portalAuthenticationApi =
        apiProvider.get(PortalAuthenticationApi.class);
    try (Response loginResponse =
        portalAuthenticationApi.login(username, password, tenant, "false", "")) {
