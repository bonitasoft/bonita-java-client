...
public final class EncodingUtils {
	 ...
	 * format.
	 * <p>
	 * Of the various collection formats defined by Swagger ("csv", "tsv", etc), Feign
	 * only natively supports "multi". This utility generates the other format types so it
	 * will be properly processed by Feign.
	 * <p>
	 * Note, as part of reformatting, it URL encodes the parameters as well.
	 * @param parameters The collection object to be formatted. This object will not be
	 * changed.
	 * @param collectionFormat The Swagger collection format (eg, "csv", "tsv", "pipes").
	 * See the <a href="http://swagger.io/specification/#parameter-object-44">OpenAPI
	 ...
	 * @return The URL encoded string representation of the parameter. If the parameter is
	 * null, returns null.
	 */
