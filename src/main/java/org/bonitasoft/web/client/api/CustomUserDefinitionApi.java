...
public interface CustomUserDefinitionApi extends ApiClient.Api {
  ...
  List<CustomUserDefinition> searchCustomUserDefinitions(@QueryMap(encoded=true) SearchCustomUserDefinitionsQueryParams queryParams);
  ...
  * but this one also exposes the Http response headers
   ...
   ApiResponse<List<CustomUserDefinition>> searchCustomUserDefinitionsWithHttpInfo(@QueryMap(encoded=true) SearchCustomUserDefinitionsQueryParams queryParams);
