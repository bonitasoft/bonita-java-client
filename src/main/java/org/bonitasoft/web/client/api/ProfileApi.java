...
public interface ProfileApi extends ApiClient.Api {
	 ...
	 * &#x60;name&#x60; - can filter on &#x60;name&#x60;,&#x60;hasNavigation&#x60; - can
	 * order on &#x60;name&#x60;
	 ...
	 * Finds Profiles Finds Profiles with pagination params and filters - can search on
	 * &#x60;name&#x60; - can filter on &#x60;name&#x60;,&#x60;hasNavigation&#x60; - can
	 * order on &#x60;name&#x60; Note, this is equivalent to the other
	 * <code>searchProfiles</code> method, but with the query parameters collected into a
	 * single Map parameter. This is convenient for services with optional query
	 * parameters, especially when used with the {@link SearchProfilesQueryParams} class
	 ...
	 */
	class SearchProfilesQueryParams extends HashMap<String, Object> {
