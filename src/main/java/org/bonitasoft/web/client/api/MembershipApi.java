...
public interface MembershipApi extends ApiClient.Api {
    ...
    ApiResponse<Void> deleteMembershipByIdWithHttpInfo(@Param("userId") String userId, @Param("groupId") String groupId,
            @Param("roleId") String roleId);
    ...
    List<Membership> searchMemberships(@Param("p") Integer p, @Param("c") Integer c, @Param("f") List<String> f,
    ...
    ApiResponse<List<Membership>> searchMembershipsWithHttpInfo(@Param("p") Integer p, @Param("c") Integer c,
    ...
    List<Membership> searchMemberships(@QueryMap(encoded = true) SearchMembershipsQueryParams queryParams);
    ...
    ApiResponse<List<Membership>> searchMembershipsWithHttpInfo(
            @QueryMap(encoded = true) SearchMembershipsQueryParams queryParams);
