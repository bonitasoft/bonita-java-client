...
public interface PlatformApi extends ApiClient.Api {
	...
	/**
	 * Update the Platform by ID Start or stop the current node, that is, start or stop
	 * all services of the current JVM.
	 * @param platformUpdateRequest Start or stop all services of the current JVM.
	 * (required)
	 */
