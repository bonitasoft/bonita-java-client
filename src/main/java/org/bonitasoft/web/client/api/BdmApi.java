...
public interface BdmApi extends ApiClient.Api {
	...
	/**
	 * Finds business data attribute by id Gets the business data attribute of business
	 * data according to its identifier and attribute name. Request url.
	 ...
	 * the {@link SearchBusinessDataByIdsQueryParams} class that allows for building up
	...
	/**
	 * Upload a BDM Upload BDM. **NOTE:** To do this, your tenant services need to be
	 * paused. In Enterprise editions, if you have an access control file installed on
	 * your tenant, you need to delete it before installing or updating your BDM.
	 * @param file (optional)
	 * @return String
	 */
	 ...
	 * <code>searchBusinessDataByIds
	 * </code> method in a fluent style.
	 */
	class SearchBusinessDataByIdsQueryParams extends HashMap<String, Object> {
