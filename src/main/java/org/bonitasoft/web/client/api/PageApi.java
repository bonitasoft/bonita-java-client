...
public interface PageApi extends ApiClient.Api {
    ...
    ApiResponse<List<Page>> searchPagesWithHttpInfo(@Param("p") Integer p, @Param("c") Integer c,
    ...
    List<Page> searchPages(@QueryMap(encoded = true) SearchPagesQueryParams queryParams);
    ...
    ApiResponse<List<Page>> searchPagesWithHttpInfo(@QueryMap(encoded = true) SearchPagesQueryParams queryParams);
