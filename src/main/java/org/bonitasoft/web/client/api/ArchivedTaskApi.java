...
public interface ArchivedTaskApi extends ApiClient.Api {
  ...
  List<ArchivedTask> searchArchivedTasks(@Param("p") Integer p, @Param("c") Integer c, @Param("f") List<String> f, @Param("o") String o);
  ...
  ApiResponse<List<ArchivedTask>> searchArchivedTasksWithHttpInfo(@Param("p") Integer p, @Param("c") Integer c, @Param("f") List<String> f, @Param("o") String o);
  ...
  * but this one also exposes the Http response headers
   ...
   ApiResponse<List<ArchivedTask>> searchArchivedTasksWithHttpInfo(@QueryMap(encoded=true) SearchArchivedTasksQueryParams queryParams);
