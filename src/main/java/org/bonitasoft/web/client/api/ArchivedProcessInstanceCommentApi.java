...
public interface ArchivedProcessInstanceCommentApi extends ApiClient.Api {
	...
	/**
	 * Finds ArchivedProcessInstanceComments Finds ArchivedProcessInstanceComments with
	 * pagination params and filters - can order on &#x60;id&#x60; - can search on
	 ...
	 * Finds ArchivedProcessInstanceComments Finds ArchivedProcessInstanceComments with
	 * pagination params and filters - can order on &#x60;id&#x60; - can search on
	 * &#x60;displayName&#x60; - can filter on &#x60;displayName&#x60; Note, this is
	 * equivalent to the other <code>
	 * searchArchivedProcessInstanceComments</code> method, but with the query parameters
	 ...
	 * {@link SearchArchivedProcessInstanceCommentsQueryParams} class that allows for
	 ...
	 */
	class SearchArchivedProcessInstanceCommentsQueryParams extends HashMap<String, Object> {
