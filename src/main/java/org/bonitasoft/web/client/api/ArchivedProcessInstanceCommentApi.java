...
public interface ArchivedProcessInstanceCommentApi extends ApiClient.Api {
  ...
  List<ArchivedProcessInstanceComment> searchArchivedProcessInstanceComments(@QueryMap(encoded=true) Map<String, Object> queryParams);
  ...
  * but this one also exposes the Http response headers
   ...
   ApiResponse<List<ArchivedProcessInstanceComment>> searchArchivedProcessInstanceCommentsWithHttpInfo(@QueryMap(encoded=true) Map<String, Object> queryParams);
