...
public interface ProcessInstanceDocumentApi extends ApiClient.Api {
  ...
  List<ProcessInstanceDocument> searchProcessInstanceDocuments(@QueryMap(encoded=true) SearchProcessInstanceDocumentsQueryParams queryParams);
  ...
  * but this one also exposes the Http response headers
   ...
   ApiResponse<List<ProcessInstanceDocument>> searchProcessInstanceDocumentsWithHttpInfo(@QueryMap(encoded=true) SearchProcessInstanceDocumentsQueryParams queryParams);
