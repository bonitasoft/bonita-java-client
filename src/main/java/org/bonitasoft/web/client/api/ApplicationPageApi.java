...
public interface ApplicationPageApi extends ApiClient.Api {
  ...
  ApiResponse<List<ApplicationPage>> searchApplicationPagesWithHttpInfo(@Param("p") Integer p, @Param("c") Integer c, @Param("f") List<String> f, @Param("o") String o, @Param("s") String s);
  ...
  List<ApplicationPage> searchApplicationPages(@QueryMap(encoded=true) SearchApplicationPagesQueryParams queryParams);
  ...
  * but this one also exposes the Http response headers
   ...
   ApiResponse<List<ApplicationPage>> searchApplicationPagesWithHttpInfo(@QueryMap(encoded=true) SearchApplicationPagesQueryParams queryParams);
