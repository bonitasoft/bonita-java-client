...
public interface ApplicationPageApi extends ApiClient.Api {
	...
	/**
	 * Finds application pages Finds application pages with pagination params and filters
	 * - can order on &#x60;id&#x60;, &#x60;token&#x60;, &#x60;applicationId&#x60;,
	 * &#x60;pageId&#x60; - can search on &#x60;token&#x60; - can filter on
	 * &#x60;id&#x60;, &#x60;token&#x60;, &#x60;applicationId&#x60;, &#x60;pageId&#x60;
	 ...
	 * &#x60;pageId&#x60; - can search on &#x60;token&#x60; - can filter on
	 * &#x60;id&#x60;, &#x60;token&#x60;, &#x60;applicationId&#x60;, &#x60;pageId&#x60;
	 * Note, this is equivalent to the other <code>
	 * searchApplicationPages</code> method, but with the query parameters collected into
	 * a single Map parameter. This is convenient for services with optional query
	 * parameters, especially when used with the {@link SearchApplicationPagesQueryParams}
	 ...
	 */
	class SearchApplicationPagesQueryParams extends HashMap<String, Object> {
