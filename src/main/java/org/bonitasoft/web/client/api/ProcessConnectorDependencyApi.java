...
public interface ProcessConnectorDependencyApi extends ApiClient.Api {
    ...
    /**
     * Finds ProcessConnectorDependencies Finds ProcessConnectorDependencies with pagination params
     * and filters **Mandatory filters: &#x60;connector_process_id&#x60;, &#x60;connector_name&#x60;,
     * &#x60;connector_version&#x60;**
     *
     ...
     * Finds ProcessConnectorDependencies Finds ProcessConnectorDependencies with pagination params
     * and filters **Mandatory filters: &#x60;connector_process_id&#x60;, &#x60;connector_name&#x60;,
     * &#x60;connector_version&#x60;** Note, this is equivalent to the other <code>
     * searchProcessConnectorDependencies</code> method, but with the query parameters collected into
     * a single Map parameter. This is convenient for services with optional query parameters,
     * especially when used with the {@link SearchProcessConnectorDependenciesQueryParams} class that
     ...
     * searchProcessConnectorDependencies</code> method in a fluent style.
     */
    public static class SearchProcessConnectorDependenciesQueryParams
