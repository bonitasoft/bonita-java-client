...
public interface ProcessConnectorDependencyApi extends ApiClient.Api {
  ...
  ApiResponse<List<ProcessConnectorDependency>> searchProcessConnectorDependenciesWithHttpInfo(@Param("p") Integer p, @Param("c") Integer c, @Param("f") List<String> f, @Param("o") String o, @Param("s") String s);
  ...
  List<ProcessConnectorDependency> searchProcessConnectorDependencies(@QueryMap(encoded=true) SearchProcessConnectorDependenciesQueryParams queryParams);
  ...
  * but this one also exposes the Http response headers
   ...
   ApiResponse<List<ProcessConnectorDependency>> searchProcessConnectorDependenciesWithHttpInfo(@QueryMap(encoded=true) SearchProcessConnectorDependenciesQueryParams queryParams);
