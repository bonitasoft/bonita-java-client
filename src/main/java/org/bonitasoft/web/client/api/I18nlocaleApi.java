...
public interface I18nlocaleApi extends ApiClient.Api {
	...
	/**
	 * Finds I18nlocales List the available I18nlocales with pagination params and filters
	 * Note, this is equivalent to the other <code>searchI18nlocales</code> method, but
	 ...
	 * {@link SearchI18nlocalesQueryParams} class that allows for building up this map in
	 * a fluent style.
	 ...
	 */
	class SearchI18nlocalesQueryParams extends HashMap<String, Object> {
