...
public interface ApplicationMenuApi extends ApiClient.Api {
    ...
    ApiResponse<ApplicationMenu> createApplicationMenuWithHttpInfo(
     ...
     * Returns application menus with pagination params and filters - can order on &#x60;id&#x60;, &#x60;displayName&#x60;, &#x60;applicationId&#x60;,
     * &#x60;applicationPageId&#x60;, &#x60;menuIndex&#x60;, &#x60;parentMenuId&#x60; - can search on &#x60;displayName&#x60; - can filter on &#x60;id&#x60;,
     * &#x60;displayName&#x60;, &#x60;applicationId&#x60;, &#x60;applicationPageId&#x60;, &#x60;menuIndex&#x60;, &#x60;parentMenuId&#x60;
     * 
    ...
    List<ApplicationMenu> searchApplicationMenus(@Param("p") Integer p, @Param("c") Integer c,
    ...
    ApiResponse<List<ApplicationMenu>> searchApplicationMenusWithHttpInfo(@Param("p") Integer p, @Param("c") Integer c,
            @Param("f") List<String> f, @Param("o") String o, @Param("s") String s);
    ...
    List<ApplicationMenu> searchApplicationMenus(
            @QueryMap(encoded = true) SearchApplicationMenusQueryParams queryParams);
    ...
    ApiResponse<List<ApplicationMenu>> searchApplicationMenusWithHttpInfo(
            @QueryMap(encoded = true) SearchApplicationMenusQueryParams queryParams);
    ...
    ApiResponse<Void> updateApplicationMenuByIdWithHttpInfo(@Param("id") String id,
