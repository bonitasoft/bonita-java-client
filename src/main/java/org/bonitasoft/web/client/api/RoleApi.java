...
public interface RoleApi extends ApiClient.Api {
    ...
    /**
     * Finds Roles
     * Finds Roles with pagination params and filters - can order on &#x60;id&#x60;, &#x60;name&#x60; and &#x60;displayName&#x60; - can filter on &#x60;name&#x60;
     * and &#x60;displayName&#x60;
     * 
    ...
    ApiResponse<List<Role>> searchRolesWithHttpInfo(@Param("p") Integer p, @Param("c") Integer c,
    ...
    List<Role> searchRoles(@QueryMap(encoded = true) SearchRolesQueryParams queryParams);
    ...
    ApiResponse<List<Role>> searchRolesWithHttpInfo(@QueryMap(encoded = true) SearchRolesQueryParams queryParams);
