...
public interface RoleApi extends ApiClient.Api {
   ...
   * &#x60;name&#x60; and &#x60;displayName&#x60; - can filter on &#x60;name&#x60; and
   * &#x60;displayName&#x60;
   *
   ...
   * Finds Roles Finds Roles with pagination params and filters - can order on &#x60;id&#x60;,
   * &#x60;name&#x60; and &#x60;displayName&#x60; - can filter on &#x60;name&#x60; and
   * &#x60;displayName&#x60; Note, this is equivalent to the other <code>searchRoles</code> method,
   ...
   * SearchRolesQueryParams} class that allows for building up this map in a fluent style.
   *
  ...
  /**
   * A convenience class for generating query parameters for the <code>searchRoles</code> method in
   * a fluent style.
   */
