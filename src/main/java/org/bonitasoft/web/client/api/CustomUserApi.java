...
public interface CustomUserApi extends ApiClient.Api {
  ...
  /**
   * Finds CustomUsers Finds CustomUsers with pagination params and filters **The filter
   * &#x60;userId&#x60; is mandatory**
   *
  ...
  List<CustomUser> searchCustomUsers(
      @Param("p") Integer p, @Param("c") Integer c, @Param("f") List<String> f);

  /**
   * Finds CustomUsers Finds CustomUsers with pagination params and filters **The filter
   * &#x60;userId&#x60; is mandatory** Note, this is equivalent to the other <code>searchCustomUsers
   ...
   * SearchCustomUsersQueryParams} class that allows for building up this map in a fluent style.
   *
  ...
  /**
   * A convenience class for generating query parameters for the <code>searchCustomUsers</code>
