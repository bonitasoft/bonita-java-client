...
public interface CustomUserApi extends ApiClient.Api {
	...
	/**
	 * Finds CustomUsers Finds CustomUsers with pagination params and filters **The filter
	 * &#x60;userId&#x60; is mandatory** Note, this is equivalent to the other
	 * <code>searchCustomUsers
	 ...
	 * especially when used with the {@link SearchCustomUsersQueryParams} class that
	 ...
	 */
	class SearchCustomUsersQueryParams extends HashMap<String, Object> {
