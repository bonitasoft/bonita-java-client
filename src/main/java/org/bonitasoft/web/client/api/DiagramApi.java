...
public interface DiagramApi extends ApiClient.Api {
     ...
     * ![edition](https://img.shields.io/badge/edition-entreprise-blue) Use the diagram resource to
     * access the process diagram xml representation. This is necessary for drawing the diagram.
     *
