...
public interface ProcessInstanceVariableApi extends ApiClient.Api {
  ...
  ProcessInstanceVariable getVariableByProcessInstanceId(
      @Param("id") String id, @Param("variableName") String variableName);

  /**
   * Finds ProcessInstance Variables Finds ProcessInstance Variables with pagination params and
   * filters
   *
  ...
  /**
   * Finds ProcessInstance Variables Finds ProcessInstance Variables with pagination params and
   * filters Note, this is equivalent to the other <code>searchProcessInstanceVariables</code>
   ...
   * SearchProcessInstanceVariablesQueryParams} class that allows for building up this map in a
   * fluent style.
   *
  ...
  /**
   * Update a Variable by ProcessInstance ID Update the variable for the given ProcessInstance ID.
   ...
   * @param id The identifier of the process instance from which to retrieve the variable (required)
   * @param variableName The name of the variable to retrieve (required)
   * @param processInstanceVariableUpdateRequest Partial ProcessInstance variables description
   *     (required)
   */
  ...
  void updateVariableByProcessInstanceId(
      @Param("id") String id,
