...
public interface ProcessInstanceVariableApi extends ApiClient.Api {
	...
	/**
	 * Finds the Variable by ProcessInstance ID Returns the single Variable for the given
	 * ProcessInstance ID
	 * @param id The identifier of the process instance from which to retrieve the
	 * variable (required)
	...
	/**
	 * Finds ProcessInstance Variables Finds ProcessInstance Variables with pagination
	 * params and filters
	...
	/**
	 * Finds ProcessInstance Variables Finds ProcessInstance Variables with pagination
	 * params and filters Note, this is equivalent to the other
	 * <code>searchProcessInstanceVariables</code> method, but with the query parameters
	 ...
	 * {@link SearchProcessInstanceVariablesQueryParams} class that allows for building up
	...
	/**
	 * Update a Variable by ProcessInstance ID Update the variable for the given
	 * ProcessInstance ID. **Warning** : only following types are supported for
	 * javaTypeclassname: &#x60;java.lang.String&#x60;, &#x60;java.lang.Integer&#x60;,
	 * &#x60;java.lang.Double&#x60;, &#x60;java.lang.Long&#x60;,
	 * &#x60;java.lang.Boolean&#x60;, &#x60;java.util.Date&#x60;
	 * @param id The identifier of the process instance from which to retrieve the
	 * variable (required)
	 * @param variableName The name of the variable to retrieve (required)
	 * @param processInstanceVariableUpdateRequest Partial ProcessInstance variables
	 ...
	 * searchProcessInstanceVariables</code> method in a fluent style.
	 */
	class SearchProcessInstanceVariablesQueryParams extends HashMap<String, Object> {
