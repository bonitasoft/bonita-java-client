...
public interface ProcessInstanceVariableApi extends ApiClient.Api {
  ...
  ApiResponse<ProcessInstanceVariable> getVariableByProcessInstanceIdWithHttpInfo(@Param("id") String id, @Param("variableName") String variableName);
  ...
  ApiResponse<List<ProcessInstanceVariable>> searchProcessInstanceVariablesWithHttpInfo(@Param("p") Integer p, @Param("c") Integer c, @Param("f") List<String> f, @Param("o") String o);
  ...
  List<ProcessInstanceVariable> searchProcessInstanceVariables(@QueryMap(encoded=true) SearchProcessInstanceVariablesQueryParams queryParams);
  ...
  * but this one also exposes the Http response headers
   ...
   ApiResponse<List<ProcessInstanceVariable>> searchProcessInstanceVariablesWithHttpInfo(@QueryMap(encoded=true) SearchProcessInstanceVariablesQueryParams queryParams);
  ...
  ApiResponse<Void> updateVariableByProcessInstanceIdWithHttpInfo(@Param("id") String id, @Param("variableName") String variableName, ProcessInstanceVariableUpdateRequest processInstanceVariableUpdateRequest);
