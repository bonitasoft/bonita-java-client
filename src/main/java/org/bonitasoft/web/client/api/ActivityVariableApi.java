...
public interface ActivityVariableApi extends ApiClient.Api {
	...
	/**
	 * Finds the ActivityVariable by ID Returns the single ActivityVariable for the given
	 * ID
	 * @param id The identifier of the activity from which to retrieve the variable
	 * (required)
