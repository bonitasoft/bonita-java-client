...
public interface ProcessInstanceApi extends ApiClient.Api {
  ...
  ProcessInstance getProcessInstanceById(@Param("id") String id, @QueryMap(encoded=true) GetProcessInstanceByIdQueryParams queryParams);
  ...
  * but this one also exposes the Http response headers
   ...
   ApiResponse<ProcessInstance> getProcessInstanceByIdWithHttpInfo(@Param("id") String id, @QueryMap(encoded=true) GetProcessInstanceByIdQueryParams queryParams);
  ...
  List<ProcessInstance> searchProcessInstances(@Param("p") Integer p, @Param("c") Integer c, @Param("f") List<String> f, @Param("o") String o);
  ...
  ApiResponse<List<ProcessInstance>> searchProcessInstancesWithHttpInfo(@Param("p") Integer p, @Param("c") Integer c, @Param("f") List<String> f, @Param("o") String o);
  ...
  List<ProcessInstance> searchProcessInstances(@QueryMap(encoded=true) SearchProcessInstancesQueryParams queryParams);
  ...
  * but this one also exposes the Http response headers
   ...
   ApiResponse<List<ProcessInstance>> searchProcessInstancesWithHttpInfo(@QueryMap(encoded=true) SearchProcessInstancesQueryParams queryParams);
