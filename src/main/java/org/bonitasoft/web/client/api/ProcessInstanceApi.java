...
public interface ProcessInstanceApi extends ApiClient.Api {
  ...
  ProcessInstance getProcessInstanceById(@Param("id") String id, @QueryMap(encoded=true) Map<String, Object> queryParams);
  ...
  * but this one also exposes the Http response headers
   ...
   ApiResponse<ProcessInstance> getProcessInstanceByIdWithHttpInfo(@Param("id") String id, @QueryMap(encoded=true) Map<String, Object> queryParams);
  ...
  * but this one also exposes the Http response headers
   ...
   ApiResponse<List<ProcessInstance>> searchProcessInstancesWithHttpInfo(@QueryMap(encoded=true) Map<String, Object> queryParams);
