...
public interface ArchivedProcessInstanceVariableApi extends ApiClient.Api {
  ...
  List<ArchivedProcessInstanceVariable> getArchivedProcessInstanceVariables(@QueryMap(encoded=true) GetArchivedProcessInstanceVariablesQueryParams queryParams);
  ...
  * but this one also exposes the Http response headers
   ...
   ApiResponse<List<ArchivedProcessInstanceVariable>> getArchivedProcessInstanceVariablesWithHttpInfo(@QueryMap(encoded=true) GetArchivedProcessInstanceVariablesQueryParams queryParams);
