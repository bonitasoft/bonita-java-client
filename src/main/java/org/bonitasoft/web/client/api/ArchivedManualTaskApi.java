...
public interface ArchivedManualTaskApi extends ApiClient.Api {
  ...
  /**
   * Finds the ArchivedManualTask by ID Returns the single ArchivedManualTask for the given ID
   *
  ...
  /**
   * Finds ArchivedManualTasks Finds ArchivedManualTasks with pagination params and filters You can
   * filter on: * &#x60;assigned_id&#x3D;{user_id}&#x60;: retrieve only the human tasks assigned to
   * the specified ID. For example, retrieve the human tasks assigned to user with id 2:
   ...
   * &#x60;name&#x3D;&#x60;: retrieve only the human tasks with the specified name. For example,
   * retrieve the human tasks with the name \&quot;Analyse ProcessInstance\&quot;:
   * &#x60;/API/bpm/archivedHumanTask?p&#x3D;0&amp;c&#x3D;10&amp;f&#x3D;name&#x3D;Analyse
   * ProcessInstance&#x60; * &#x60;displayName&#x3D;&#x60;: retrieve only the archived user tasks
   * with the specified displayName. For example, retrieve the human tasks with the displayName
  ...
  List<ArchivedManualTask> searchArchivedManualTasks(
      @Param("p") Integer p,
      @Param("c") Integer c,
   ...
   * \&quot;Analyse ProcessInstance\&quot;:
   * &#x60;/API/bpm/archivedHumanTask?p&#x3D;0&amp;c&#x3D;10&amp;f&#x3D;displayName&#x3D;Analyse
   * ProcessInstance&#x60; Note, this is equivalent to the other <code>searchArchivedManualTasks
   ...
   * SearchArchivedManualTasksQueryParams} class that allows for building up this map in a fluent
   * style.
   *
  ...
  /**
   * A convenience class for generating query parameters for the <code>searchArchivedManualTasks
   * </code> method in a fluent style.
   */
  public static class SearchArchivedManualTasksQueryParams extends HashMap<String, Object> {
