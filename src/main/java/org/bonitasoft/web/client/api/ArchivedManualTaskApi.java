...
public interface ArchivedManualTaskApi extends ApiClient.Api {
    ...
    ApiResponse<List<ArchivedManualTask>> searchArchivedManualTasksWithHttpInfo(@Param("p") Integer p,
    ...
    List<ArchivedManualTask> searchArchivedManualTasks(
            @QueryMap(encoded = true) SearchArchivedManualTasksQueryParams queryParams);
    ...
    ApiResponse<List<ArchivedManualTask>> searchArchivedManualTasksWithHttpInfo(
            @QueryMap(encoded = true) SearchArchivedManualTasksQueryParams queryParams);
