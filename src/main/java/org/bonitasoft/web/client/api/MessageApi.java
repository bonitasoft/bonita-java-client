...
public interface MessageApi extends ApiClient.Api {
  ...
  /**
   * Send BPM message events Use this resource to send BPM message events. Message events are caught
   * by processes using &#x60;catch message event&#x60; flow nodes (Start, intermediate, boundary or
   * receive tasks).
   *
