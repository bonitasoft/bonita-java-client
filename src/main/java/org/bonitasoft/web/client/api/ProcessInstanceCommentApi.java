...
public interface ProcessInstanceCommentApi extends ApiClient.Api {
	 ...
	 * @param body The process instance (case) id and the comment content, in JSON
	 * (required)
	...
	/**
	 * Finds ProcessInstanceComments Finds ProcessInstanceComments with pagination params
	 * and filters - can order on &#x60;postDate&#x60; - can filter on
	 * &#x60;supervisor_id&#x60;,&#x60;user_id&#x60;,&#x60;processInstanceId&#x60; - You
	 ...
	 * and filters - can order on &#x60;postDate&#x60; - can filter on
	 * &#x60;supervisor_id&#x60;,&#x60;user_id&#x60;,&#x60;processInstanceId&#x60; - You
	 * cannot use supervisor_id and user_id filter at the same time Note, this is
	 * equivalent to the other <code>
	 * searchProcessInstanceComments</code> method, but with the query parameters
	 ...
	 * {@link SearchProcessInstanceCommentsQueryParams} class that allows for building up
	 ...
	 * <code>searchProcessInstanceComments
	 * </code> method in a fluent style.
	 */
	class SearchProcessInstanceCommentsQueryParams extends HashMap<String, Object> {
