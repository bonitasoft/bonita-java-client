...
public interface ArchivedFlowNodeApi extends ApiClient.Api {
  ...
  ApiResponse<List<ArchivedFlowNode>> searchArchivedFlowNodesWithHttpInfo(@Param("p") Integer p, @Param("c") Integer c, @Param("f") List<String> f, @Param("o") String o, @Param("s") String s);
  ...
  List<ArchivedFlowNode> searchArchivedFlowNodes(@QueryMap(encoded=true) SearchArchivedFlowNodesQueryParams queryParams);
  ...
  * but this one also exposes the Http response headers
   ...
   ApiResponse<List<ArchivedFlowNode>> searchArchivedFlowNodesWithHttpInfo(@QueryMap(encoded=true) SearchArchivedFlowNodesQueryParams queryParams);
