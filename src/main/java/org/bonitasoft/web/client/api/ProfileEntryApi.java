...
public interface ProfileEntryApi extends ApiClient.Api {
	...
	/**
	 * Finds ProfileEntries Finds ProfileEntries with pagination params and filters - can
	 * search on &#x60;name&#x60; - can filter on &#x60;page&#x60;,&#x60;name&#x60; and
	 * &#x60;parent_id&#x60;
	...
	@Headers({ "Accept: application/json", })
	List<ProfileEntry> searchProfileEntries(@Param("p") Integer p, @Param("c") Integer c, @Param("f") List<String> f,
			@Param("s") String s);

	/**
	 * Finds ProfileEntries Finds ProfileEntries with pagination params and filters - can
	 * search on &#x60;name&#x60; - can filter on &#x60;page&#x60;,&#x60;name&#x60; and
	 * &#x60;parent_id&#x60; Note, this is equivalent to the other
	 * <code>searchProfileEntries</code> method, but with the query parameters collected
	 * into a single Map parameter. This is convenient for services with optional query
	 * parameters, especially when used with the {@link SearchProfileEntriesQueryParams}
	 ...
	 */
	class SearchProfileEntriesQueryParams extends HashMap<String, Object> {
