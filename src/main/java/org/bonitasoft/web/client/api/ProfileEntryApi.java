...
public interface ProfileEntryApi extends ApiClient.Api {
    ...
    ApiResponse<List<ProfileEntry>> searchProfileEntriesWithHttpInfo(@Param("p") Integer p, @Param("c") Integer c,
            @Param("f") List<String> f, @Param("s") String s);
    ...
    List<ProfileEntry> searchProfileEntries(@QueryMap(encoded = true) SearchProfileEntriesQueryParams queryParams);
    ...
    ApiResponse<List<ProfileEntry>> searchProfileEntriesWithHttpInfo(
    ...
    ApiResponse<Void> updateProfileEntryByIdWithHttpInfo(@Param("id") String id,
