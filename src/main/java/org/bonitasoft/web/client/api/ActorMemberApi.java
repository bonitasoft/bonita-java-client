...
public interface ActorMemberApi extends ApiClient.Api {
    ...
    ApiResponse<List<ActorMember>> searchActorMembersWithHttpInfo(@Param("p") Integer p, @Param("c") Integer c,
    ...
    ApiResponse<List<ActorMember>> searchActorMembersWithHttpInfo(
            @QueryMap(encoded = true) SearchActorMembersQueryParams queryParams);
