...
public interface ActorMemberApi extends ApiClient.Api {
	 ...
	 * **mandatory** filter on: * &#x60;actor_id&#x60; For example, retrieve the
	 * actorMembers related to the specified actor_id.
	 * http://localhost:8080/bonita/API/bpm/actorMember?p&#x3D;0&amp;c&#x3D;10&amp;f&#x3D;actor_id%3d1
	 * You can also filter also on: * &#x60;member_type&#x60;
	 * (user|role|group|roleAndGroup) retrieve only the actorMembers of type user.
	...
	@Headers({ "Accept: application/json", })
	List<ActorMember> searchActorMembers(@Param("p") Integer p, @Param("c") Integer c, @Param("f") List<String> f,
			@Param("o") String o);
	 ...
	 * group_id.
	 * &#x60;/API/bpm/actorMember?p&#x3D;0&amp;c&#x3D;10&amp;f&#x3D;actor_id%3d1&amp;f&#x3D;group_id%3d101&#x60;
	 * Note, this is equivalent to the other <code>searchActorMembers</code> method, but
	 * with the query parameters collected into a single Map parameter. This is convenient
	 * for services with optional query parameters, especially when used with the
	 * {@link SearchActorMembersQueryParams} class that allows for building up this map in
	 * a fluent style.
	 ...
	 */
	class SearchActorMembersQueryParams extends HashMap<String, Object> {
