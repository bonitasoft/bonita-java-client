...
public interface ActorMemberApi extends ApiClient.Api {
   ...
   */
  @RequestLine("DELETE /API/bpm/actorMemberEntry/{id}")
  @Headers({
  ...
  /**
   * Finds ActorMembers Finds ActorMembers with pagination params and filters There is a
   * **mandatory** filter on: * &#x60;actor_id&#x60; For example, retrieve the actorMembers related
   * to the specified actor_id.
   * http://localhost:8080/bonita/API/bpm/actorMember?p&#x3D;0&amp;c&#x3D;10&amp;f&#x3D;actor_id%3d1
   * You can also filter also on: * &#x60;member_type&#x60; (user|role|group|roleAndGroup) retrieve
   * only the actorMembers of type user.
   * &#x60;/API/bpm/actorMember?p&#x3D;0&amp;c&#x3D;10&amp;f&#x3D;actor_id%3d1&amp;f&#x3D;member_type%3duser&#x60;
   * * &#x60;user_id&#x60;: retrieve only the actorMembers related to the specified user_id.
   * &#x60;/API/bpm/actorMember?p&#x3D;0&amp;c&#x3D;10&amp;f&#x3D;actor_id%3d1&amp;f&#x3D;user_id%3d101&#x60;
   * * &#x60;role_id&#x60;: retrieve only the actorMembers related to the specified role_id.
   * &#x60;/API/bpm/actorMember?p&#x3D;0&amp;c&#x3D;10&amp;f&#x3D;actor_id%3d1&amp;f&#x3D;role_id%3d101&#x60;
   * * &#x60;group_id&#x60;: retrieve only the actorMembers related to the specified group_id.
   ...
   */
  @RequestLine("GET /API/bpm/actorMemberEntry?p={p}&c={c}&f={f}&o={o}")
  @Headers({
    "Accept: application/json",
  })
  List<ActorMember> searchActorMembers(
      @Param("p") Integer p,
      @Param("c") Integer c,
   ...
   * * &#x60;group_id&#x60;: retrieve only the actorMembers related to the specified group_id.
   * &#x60;/API/bpm/actorMember?p&#x3D;0&amp;c&#x3D;10&amp;f&#x3D;actor_id%3d1&amp;f&#x3D;group_id%3d101&#x60;
   * Note, this is equivalent to the other <code>searchActorMembers</code> method, but with the
   * query parameters collected into a single Map parameter. This is convenient for services with
   * optional query parameters, especially when used with the {@link SearchActorMembersQueryParams}
  ...
  /**
   * A convenience class for generating query parameters for the <code>searchActorMembers</code>
