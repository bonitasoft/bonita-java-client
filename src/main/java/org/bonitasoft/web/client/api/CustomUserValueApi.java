...
public interface CustomUserValueApi extends ApiClient.Api {
	...
	/**
	 * Finds CustomUserValues Finds CustomUserValues with pagination params and filters
	 ...
	 * the {@link SearchCustomUserValuesQueryParams} class that allows for building up
	 ...
	 */
	class SearchCustomUserValuesQueryParams extends HashMap<String, Object> {
