...
public interface CustomUserValueApi extends ApiClient.Api {
  ...
  List<CustomUserValue> searchCustomUserValues(@QueryMap(encoded=true) SearchCustomUserValuesQueryParams queryParams);
  ...
  * but this one also exposes the Http response headers
   ...
   ApiResponse<List<CustomUserValue>> searchCustomUserValuesWithHttpInfo(@QueryMap(encoded=true) SearchCustomUserValuesQueryParams queryParams);
