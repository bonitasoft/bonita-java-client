...
public interface CustomUserValueApi extends ApiClient.Api {
  ...
  /**
   * Finds CustomUserValues Finds CustomUserValues with pagination params and filters You can filter
   * on &#x60;userId&#x60;, &#x60;value&#x60;, &#x60;definitionId&#x60;
   *
  ...
  /**
   * Finds CustomUserValues Finds CustomUserValues with pagination params and filters You can filter
   * on &#x60;userId&#x60;, &#x60;value&#x60;, &#x60;definitionId&#x60; Note, this is equivalent to
   * the other <code>searchCustomUserValues</code> method, but with the query parameters collected
   * into a single Map parameter. This is convenient for services with optional query parameters,
   * especially when used with the {@link SearchCustomUserValuesQueryParams} class that allows for
  ...
  /**
   * A convenience class for generating query parameters for the <code>searchCustomUserValues</code>
  ...
  /**
   * Update the CustomUserValue by ID Update the CustomUserValue for the given ID
   *
  ...
  void updateCustomUserValueById(
