...
public interface BusinessDataQueryApi extends ApiClient.Api {
	...
	/**
	 * Finds Business Data Finds Business Data with pagination params and filters by
	 * calling a &#x60;Named Query&#x60;. The business data query REST API resource is
	 * used to call a default or custom business data query. It is available from version
	 * 6.5. **Data parameters**: * businessDataType - the fully-qualified business data
	 * type name * q&#x3D;queryName - the query name * p&#x3D;0 - the page number *
	 * c&#x3D;10 - the maximum number of results in the page * f&#x3D;parameter&#x3D;value
	 * - sets the parameter value according to business data query parameters defined in
	 * Bonita Studio For a Boolean parameter, the accepted values are &#x60;true&#x60; or
	 * &#x60;false&#x60;. By default, for a Date parameter can use the following formats:
	...
	List<BusinessData> searchBusinessData(@Param("businessDataType") String businessDataType, @Param("q") String q,
	 ...
	 * searchBusinessData</code> method, but with the query parameters collected into a
	 * single Map parameter. This is convenient for services with optional query
	 * parameters, especially when used with the {@link SearchBusinessDataQueryParams}
	...
	@RequestLine("GET /API/bdm/businessData/{businessDataType}?q={q}&p={p}&c={c}&f={f}")
	@Headers({ "Accept: application/json", })
	List<BusinessData> searchBusinessData(@Param("businessDataType") String businessDataType,
	 ...
	 */
	class SearchBusinessDataQueryParams extends HashMap<String, Object> {
