...
public interface FormMappingApi extends ApiClient.Api {
  ...
  /**
   * Finds FormMappings Finds FormMappings with pagination params and filters - can filter on
  ...
  List<FormMapping> searchFormMappings(
      @Param("p") Integer p,
      @Param("c") Integer c,
  ...
  /**
   * Finds FormMappings Finds FormMappings with pagination params and filters - can filter on
   * &#x60;processDefinitionId&#x60;,&#x60;type&#x60; Note, this is equivalent to the other <code>
   * searchFormMappings</code> method, but with the query parameters collected into a single Map
   * parameter. This is convenient for services with optional query parameters, especially when used
   * with the {@link SearchFormMappingsQueryParams} class that allows for building up this map in a
   * fluent style.
   *
  ...
  /**
   * A convenience class for generating query parameters for the <code>searchFormMappings</code>
  ...
  /**
   * Update the FormMapping by ID ![edition](https://img.shields.io/badge/edition-entreprise-blue)
   * Update the FormMapping for the given ID
   *
   * @param id ID of the FormMapping to return (required)
   * @param formMappingUpdateRequest Representation of the form mapping attribute to update -
   *     {&#39;pageId&#39;: (long)} or {&#39;url&#39;: (string)} or {} to set the mapping type to
   *     NONE (required)
   */
  ...
  void updateFormMappingById(
      @Param("id") String id, FormMappingUpdateRequest formMappingUpdateRequest);
}
