...
public interface FormMappingApi extends ApiClient.Api {
	...
	/**
	 * Finds FormMappings Finds FormMappings with pagination params and filters - can
	 * filter on &#x60;processDefinitionId&#x60;,&#x60;type&#x60;
	...
	/**
	 * Finds FormMappings Finds FormMappings with pagination params and filters - can
	 * filter on &#x60;processDefinitionId&#x60;,&#x60;type&#x60; Note, this is equivalent
	 * to the other <code>
	 * searchFormMappings</code> method, but with the query parameters collected into a
	 * single Map parameter. This is convenient for services with optional query
	 * parameters, especially when used with the {@link SearchFormMappingsQueryParams}
	 ...
	 * FormMapping for the given ID
	 * @param id ID of the FormMapping to return (required)
	 * @param formMappingUpdateRequest Representation of the form mapping attribute to
	 * update - {&#39;pageId&#39;: (long)} or {&#39;url&#39;: (string)} or {} to set the
	 * mapping type to NONE (required)
	 */
	 ...
	 */
	class SearchFormMappingsQueryParams extends HashMap<String, Object> {
