...
public interface ProfessionalContactDataApi extends ApiClient.Api {
	 ...
	 * @param body Partial ProfessionalContactData description including the user ID
	 * (required)
	...
	/**
	 * Finds the PersonalContactData by ID Returns the single PersonalContactData for the
	 * given ID
	...
	/**
	 * Finds the ProfessionalContactData by ID Returns the single ProfessionalContactData
	 * for the given ID
	...
	/**
	 * Finds ProfessionalContactData Finds ProfessionalContactData with pagination params
	 * and filters - can order on &#x60;id&#x60; - can search on &#x60;displayName&#x60; -
	 ...
	 * Finds ProfessionalContactData Finds ProfessionalContactData with pagination params
	 * and filters - can order on &#x60;id&#x60; - can search on &#x60;displayName&#x60; -
	 * can filter on &#x60;displayName&#x60; Note, this is equivalent to the other <code>
	 * searchProfessionalContactDatas</code> method, but with the query parameters
	 ...
	 * {@link SearchProfessionalContactDatasQueryParams} class that allows for building up
	...
	/**
	 * Update the PersonalContactData by ID Update the PersonalContactData for the given
	 * ID
	 * @param userId User ID of the PersonalContactData to update (required)
	 * @param professionalContactData Partial PersonalContactData description including
	...
	/**
	 * Update the ProfessionalContactData by ID Update the ProfessionalContactData for the
	 * given ID
	 * @param userId User ID of the ProfessionalContactData to update (required)
	 * @param professionalContactData Partial ProfessionalContactData description
	 * including the user ID (required)
	 */
	 ...
	 * searchProfessionalContactDatas</code> method in a fluent style.
	 */
	class SearchProfessionalContactDatasQueryParams extends HashMap<String, Object> {
