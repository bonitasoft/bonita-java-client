...
public interface ProfessionalContactDataApi extends ApiClient.Api {
  ...
  ApiResponse<List<ProfessionalContactData>> searchProfessionalContactDatasWithHttpInfo(@Param("p") Integer p, @Param("c") Integer c, @Param("f") List<String> f, @Param("o") String o, @Param("s") String s);
  ...
  List<ProfessionalContactData> searchProfessionalContactDatas(@QueryMap(encoded=true) SearchProfessionalContactDatasQueryParams queryParams);
  ...
  * but this one also exposes the Http response headers
   ...
   ApiResponse<List<ProfessionalContactData>> searchProfessionalContactDatasWithHttpInfo(@QueryMap(encoded=true) SearchProfessionalContactDatasQueryParams queryParams);
  ...
  ApiResponse<Void> updatePersonalContactDataByIdWithHttpInfo(@Param("userId") String userId, ProfessionalContactData professionalContactData);
  ...
  ApiResponse<Void> updateProfessionalContactDataByIdWithHttpInfo(@Param("userId") String userId, ProfessionalContactData professionalContactData);
