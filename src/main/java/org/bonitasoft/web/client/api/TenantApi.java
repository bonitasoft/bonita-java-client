...
public interface TenantApi extends ApiClient.Api {
	...
	/**
	 * Create the Tenant ![edition](https://img.shields.io/badge/edition-entreprise-blue)
	 * Create the Tenant
	 ...
	 * ![edition](https://img.shields.io/badge/edition-entreprise-blue) Delete the single
	 * Tenant for the given ID
	 ...
	 * ![edition](https://img.shields.io/badge/edition-entreprise-blue) Returns the single
	 * Tenant for the given ID
	...
	/**
	 * Finds Tenants ![edition](https://img.shields.io/badge/edition-entreprise-blue)
	 * Finds Tenants with pagination params and filters - can order on &#x60;id&#x60; -
	 * can search on &#x60;displayName&#x60; - can filter on &#x60;displayName&#x60;
	...
	@Headers({ "Accept: application/json", })
	List<Tenant> searchTenants(@Param("p") Integer p, @Param("c") Integer c, @Param("f") List<String> f,
			@Param("o") String o, @Param("s") String s);

	/**
	 * Finds Tenants ![edition](https://img.shields.io/badge/edition-entreprise-blue)
	 * Finds Tenants with pagination params and filters - can order on &#x60;id&#x60; -
	 * can search on &#x60;displayName&#x60; - can filter on &#x60;displayName&#x60; Note,
	 * this is equivalent to the other <code>searchTenants</code> method, but with the
	 ...
	 * {@link SearchTenantsQueryParams} class that allows for building up this map in a
	 * fluent style.
	 ...
	 * ![edition](https://img.shields.io/badge/edition-entreprise-blue) Update the Tenant
	 * for the given ID
	 * @param id ID of the Tenant to return (required)
	 ...
	 */
	class SearchTenantsQueryParams extends HashMap<String, Object> {
