...
public interface TenantApi extends ApiClient.Api {
    ...
    ApiResponse<List<Tenant>> searchTenantsWithHttpInfo(@Param("p") Integer p, @Param("c") Integer c,
     ...
     * ![edition](https://img.shields.io/badge/edition-entreprise-blue) ![edition](https://img.shields.io/badge/edition-community-brightgreen) Update a Tenant
