...
public interface I18ntranslationApi extends ApiClient.Api {
  ...
  List<Map<String, String>> searchI18ntranslations(@QueryMap(encoded=true) SearchI18ntranslationsQueryParams queryParams);
  ...
  * but this one also exposes the Http response headers
   ...
   ApiResponse<List<Map<String, String>>> searchI18ntranslationsWithHttpInfo(@QueryMap(encoded=true) SearchI18ntranslationsQueryParams queryParams);
