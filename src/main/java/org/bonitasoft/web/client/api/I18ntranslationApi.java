...
public interface I18ntranslationApi extends ApiClient.Api {
	...
	/**
	 * Finds I18ntranslations List the available I18ntranslations with pagination params
	 * and filters Returns all translations of the product. If a locale is specified in
	 * the filter, that translation for that locale are returned. If no locale is
	 * specified, the translations in English are returned. You can filter on
	 * &#x60;locale&#x60;
	 ...
	 * the filter, that translation for that locale are returned. If no locale is
	 * specified, the translations in English are returned. You can filter on
	 * &#x60;locale&#x60; Note, this is equivalent to the other
	 * <code>searchI18ntranslations</code> method, but with the query parameters collected
	 * into a single Map parameter. This is convenient for services with optional query
	 * parameters, especially when used with the {@link SearchI18ntranslationsQueryParams}
	 ...
	 */
	class SearchI18ntranslationsQueryParams extends HashMap<String, Object> {
