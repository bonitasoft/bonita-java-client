...
public interface ArchivedUserTaskApi extends ApiClient.Api {
    ...
    /**
     * Finds the ArchivedUserTask by ID Returns the single ArchivedUserTask for the given ID
     *
    ...
    /**
     * Finds ArchivedUserTasks Finds ArchivedUserTasks with pagination params and filters. An
     * ArchivedUserTask is an executable task that has been performed by a user or skipped and is
     * archived. You can filter on: * &#x60;assigned_id&#x3D;{user_id}&#x60;: retrieve only the user
     * tasks assigned to the specified ID. For example, retrieve the user tasks assigned to user with
     * id 2: &#x60;/API/bpm/archivedUserTask?p&#x3D;0&amp;c&#x3D;10&amp;f&#x3D;assigned_id%3d2&#x60; *
     * &#x60;state&#x3D;&#x60;: retrieve only the archived user tasks with the specified state. For
     * example, retrieve the skipped tasks:
     * &#x60;/API/bpm/archivedUserTask?p&#x3D;0&amp;c&#x3D;10&amp;f&#x3D;state&#x3D;skipped&#x60; *
     * &#x60;name&#x3D;&#x60;: retrieve only the user tasks with the specified name. For example,
     * retrieve the user tasks with the name \&quot;Analyse ProcessInstance\&quot;:
     * &#x60;/API/bpm/archivedUserTask?p&#x3D;0&amp;c&#x3D;10&amp;f&#x3D;name&#x3D;Analyse
     * ProcessInstance&#x60; * &#x60;displayName&#x3D;&#x60;: retrieve only the archived user tasks
     * with the specified displayName. For example, retrieve the user tasks with the displayName
     * \&quot;Analyse ProcessInstance\&quot;:
     * &#x60;/API/bpm/archivedUserTask?p&#x3D;0&amp;c&#x3D;10&amp;f&#x3D;displayName&#x3D;Analyse
     * ProcessInstance&#x60;
     *
     ...
     * \&quot;Analyse ProcessInstance\&quot;:
     * &#x60;/API/bpm/archivedUserTask?p&#x3D;0&amp;c&#x3D;10&amp;f&#x3D;displayName&#x3D;Analyse
     * ProcessInstance&#x60; Note, this is equivalent to the other <code>searchArchivedUserTasks
     ...
     * SearchArchivedUserTasksQueryParams} class that allows for building up this map in a fluent
     * style.
     *
    ...
    /**
     * A convenience class for generating query parameters for the <code>searchArchivedUserTasks
