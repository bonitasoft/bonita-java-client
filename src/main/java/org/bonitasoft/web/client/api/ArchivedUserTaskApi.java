...
public interface ArchivedUserTaskApi extends ApiClient.Api {
  ...
  ApiResponse<List<ArchivedUserTask>> searchArchivedUserTasksWithHttpInfo(@Param("p") Integer p, @Param("c") Integer c, @Param("f") List<String> f, @Param("o") String o);
  ...
  List<ArchivedUserTask> searchArchivedUserTasks(@QueryMap(encoded=true) SearchArchivedUserTasksQueryParams queryParams);
  ...
  * but this one also exposes the Http response headers
   ...
   ApiResponse<List<ArchivedUserTask>> searchArchivedUserTasksWithHttpInfo(@QueryMap(encoded=true) SearchArchivedUserTasksQueryParams queryParams);
