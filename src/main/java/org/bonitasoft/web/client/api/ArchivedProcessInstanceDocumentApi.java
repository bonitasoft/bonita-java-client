...
public interface ArchivedProcessInstanceDocumentApi extends ApiClient.Api {
	...
	List<ArchivedProcessInstanceDocument> searchArchivedProcessInstanceDocuments(@QueryMap(encoded = true) Map<String, Object> queryParams);
	...
	ApiResponse<List<ArchivedProcessInstanceDocument>> searchArchivedProcessInstanceDocumentsWithHttpInfo(@QueryMap(encoded = true) Map<String, Object> queryParams);
