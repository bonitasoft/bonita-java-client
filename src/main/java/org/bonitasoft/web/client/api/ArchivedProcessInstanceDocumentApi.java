...
public interface ArchivedProcessInstanceDocumentApi extends ApiClient.Api {
  ...
  List<ArchivedProcessInstanceDocument> searchArchivedProcessInstanceDocuments(@Param("p") Integer p, @Param("c") Integer c, @Param("f") List<String> f, @Param("o") String o);
  ...
  ApiResponse<List<ArchivedProcessInstanceDocument>> searchArchivedProcessInstanceDocumentsWithHttpInfo(@Param("p") Integer p, @Param("c") Integer c, @Param("f") List<String> f, @Param("o") String o);
  ...
  List<ArchivedProcessInstanceDocument> searchArchivedProcessInstanceDocuments(@QueryMap(encoded=true) SearchArchivedProcessInstanceDocumentsQueryParams queryParams);
  ...
  * but this one also exposes the Http response headers
   ...
   ApiResponse<List<ArchivedProcessInstanceDocument>> searchArchivedProcessInstanceDocumentsWithHttpInfo(@QueryMap(encoded=true) SearchArchivedProcessInstanceDocumentsQueryParams queryParams);
