...
public interface ArchivedProcessInstanceDocumentApi extends ApiClient.Api {
    ...
    /**
     * Finds ArchivedProcessInstanceDocuments Finds ArchivedProcessInstanceDocuments with pagination
     * params and filters You can filter on : * &#x60;sourceObjectId&#x3D;\&quot;id\&quot;&#x60;:
     * search for documents by specifying the original document id. This is useful if you know the id
     * of a ProcessInstanceDocument and you wish to retrieve all its previous versions.. *
     * &#x60;caseId&#x3D;\&quot;id\&quot;&#x60;: search for documents with the specified open process
     * instance id. * &#x60;archivedProcessInstanceId&#x3D;\&quot;id\&quot;&#x60;: search for
     * documents with the specified archvied process instance id. *
     * &#x60;submittedBy&#x3D;\&quot;id\&quot;&#x60;: search for documents that were submitted by the
     * user with the specified identifier. * &#x60;name&#x3D;\&quot;string\&quot;&#x60;: search for
     * documents with names that contain _string_. Depending on the setting for [word-based
     * search](using-list-and-search-methods.md), the search returns documents with _string_ at the
     * start of the name or the start of a word in the name. *
     ...
     * the other <code>searchArchivedProcessInstanceDocuments</code> method, but with the query
     ...
     * SearchArchivedProcessInstanceDocumentsQueryParams} class that allows for building up this map
     * in a fluent style.
     *
     ...
     */
    public static class SearchArchivedProcessInstanceDocumentsQueryParams
