...
public interface ProcessResolutionProblemApi extends ApiClient.Api {
	...
	/**
	 * Finds ProcessResolutionProblems Finds ProcessResolutionProblems with pagination
	 * params and filters to list the problems that need to be solved before a process can
	 * be used. **Filtering on the process definition ID is mandatory.**
	 ...
	 * Finds ProcessResolutionProblems Finds ProcessResolutionProblems with pagination
	 * params and filters to list the problems that need to be solved before a process can
	 * be used. **Filtering on the process definition ID is mandatory.** Note, this is
	 * equivalent to the other <code>
	 * searchProcessResolutionProblems</code> method, but with the query parameters
	 ...
	 * {@link SearchProcessResolutionProblemsQueryParams} class that allows for building
	 ...
	 * searchProcessResolutionProblems</code> method in a fluent style.
	 */
	class SearchProcessResolutionProblemsQueryParams extends HashMap<String, Object> {
