...
public interface ProcessResolutionProblemApi extends ApiClient.Api {
  ...
  List<ProcessResolutionProblem> searchProcessResolutionProblems(@QueryMap(encoded=true) SearchProcessResolutionProblemsQueryParams queryParams);
  ...
  * but this one also exposes the Http response headers
   ...
   ApiResponse<List<ProcessResolutionProblem>> searchProcessResolutionProblemsWithHttpInfo(@QueryMap(encoded=true) SearchProcessResolutionProblemsQueryParams queryParams);
