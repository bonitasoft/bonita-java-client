...
public interface ProcessSupervisorApi extends ApiClient.Api {
  ...
  ApiResponse<List<ProcessSupervisor>> searchProcessSupervisorsWithHttpInfo(@Param("p") Integer p, @Param("c") Integer c, @Param("f") List<String> f, @Param("o") String o, @Param("s") String s);
  ...
  List<ProcessSupervisor> searchProcessSupervisors(@QueryMap(encoded=true) SearchProcessSupervisorsQueryParams queryParams);
  ...
  * but this one also exposes the Http response headers
   ...
   ApiResponse<List<ProcessSupervisor>> searchProcessSupervisorsWithHttpInfo(@QueryMap(encoded=true) SearchProcessSupervisorsQueryParams queryParams);
