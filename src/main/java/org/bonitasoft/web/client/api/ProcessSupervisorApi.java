...
public interface ProcessSupervisorApi extends ApiClient.Api {
  ...
  /**
   * Delete the ProcessSupervisor by ID Delete the ProcessSupervisor for the given compoound IDs You
   * can delete a process supervisor by specifying its compound Id in the body of the request with
   * the following format: &#x60;process_id/user_id/role_id/group_id&#x60;
   *
   * @param requestBody The process definition id and either the user, role and/or group id.
   *     (required)
   */
  ...
  /**
   * Finds ProcessSupervisors Finds ProcessSupervisors with pagination params and filters To filter,
   * you need to specify the &#x60;process_id&#x60;, and then the &#x60;user_id&#x60;,
   * &#x60;group_id&#x60; and &#x60;role_id&#x60; with one of them (two if you want to filter on
   * group and role) set to &#x60;&gt;0&#x60; and the other ones set to &#x60;-1&#x60;. E.g.:
   ...
   * group and role) set to &#x60;&gt;0&#x60; and the other ones set to &#x60;-1&#x60;. E.g.:
   * &#x60;f&#x3D;process_id%3D8040901857674754544&amp;f&#x3D;user_id%3D&gt;0&amp;f&#x3D;group_id%3D-1&amp;f&#x3D;role_id%3D-1&#x60;
   * Note, this is equivalent to the other <code>searchProcessSupervisors</code> method, but with
   * the query parameters collected into a single Map parameter. This is convenient for services
   * with optional query parameters, especially when used with the {@link
   * SearchProcessSupervisorsQueryParams} class that allows for building up this map in a fluent
   * style.
   *
  ...
  /**
   * A convenience class for generating query parameters for the <code>searchProcessSupervisors
