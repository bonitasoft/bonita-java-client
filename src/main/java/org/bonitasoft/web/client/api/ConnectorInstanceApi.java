...
public interface ConnectorInstanceApi extends ApiClient.Api {
	...
	/**
	 * Finds ConnectorInstances Finds ConnectorInstances with pagination params and
	 * filters. Retrieve a list of connector instances attached to a process or a flow
	 * node.
	 ...
	 * Finds ConnectorInstances Finds ConnectorInstances with pagination params and
	 * filters. Retrieve a list of connector instances attached to a process or a flow
	 * node. Note, this is equivalent to the other <code>searchConnectorInstances</code>
	 ...
	 * with the {@link SearchConnectorInstancesQueryParams} class that allows for building
	 ...
	 * <code>searchConnectorInstances
	 * </code> method in a fluent style.
	 */
	class SearchConnectorInstancesQueryParams extends HashMap<String, Object> {
