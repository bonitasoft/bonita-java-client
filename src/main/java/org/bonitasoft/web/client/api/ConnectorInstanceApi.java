...
public interface ConnectorInstanceApi extends ApiClient.Api {
    ...
    /**
     * Finds ConnectorInstances Finds ConnectorInstances with pagination params and filters. Retrieve
     * a list of connector instances attached to a process or a flow node.
     *
    ...
    /**
     * Finds ConnectorInstances Finds ConnectorInstances with pagination params and filters. Retrieve
     * a list of connector instances attached to a process or a flow node. Note, this is equivalent to
     * the other <code>searchConnectorInstances</code> method, but with the query parameters collected
     * into a single Map parameter. This is convenient for services with optional query parameters,
     * especially when used with the {@link SearchConnectorInstancesQueryParams} class that allows for
    ...
    /**
     * A convenience class for generating query parameters for the <code>searchConnectorInstances
