...
public interface ConnectorInstanceApi extends ApiClient.Api {
  ...
  ApiResponse<List<ConnectorInstance>> searchConnectorInstancesWithHttpInfo(@Param("p") Integer p, @Param("c") Integer c, @Param("f") List<String> f, @Param("o") String o, @Param("s") String s);
  ...
  List<ConnectorInstance> searchConnectorInstances(@QueryMap(encoded=true) SearchConnectorInstancesQueryParams queryParams);
  ...
  * but this one also exposes the Http response headers
   ...
   ApiResponse<List<ConnectorInstance>> searchConnectorInstancesWithHttpInfo(@QueryMap(encoded=true) SearchConnectorInstancesQueryParams queryParams);
