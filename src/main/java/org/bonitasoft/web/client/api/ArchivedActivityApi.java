...
public interface ArchivedActivityApi extends ApiClient.Api {
  ...
  ApiResponse<List<ArchivedActivity>> searchArchivedActivitiesWithHttpInfo(@Param("p") Integer p, @Param("c") Integer c, @Param("f") List<String> f, @Param("o") String o, @Param("s") String s);
  ...
  List<ArchivedActivity> searchArchivedActivities(@QueryMap(encoded=true) SearchArchivedActivitiesQueryParams queryParams);
  ...
  * but this one also exposes the Http response headers
   ...
   ApiResponse<List<ArchivedActivity>> searchArchivedActivitiesWithHttpInfo(@QueryMap(encoded=true) SearchArchivedActivitiesQueryParams queryParams);
