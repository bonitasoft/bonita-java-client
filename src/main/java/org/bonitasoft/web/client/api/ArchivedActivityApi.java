...
public interface ArchivedActivityApi extends ApiClient.Api {
	...
	/**
	 * Finds the Archived Activity by ID Returns the single Archived Activity for the
	 * given ID
	...
	/**
	 * Finds Archived Activities Finds Archived Activities with pagination params and
	 * filters. Activities in states completed, cancelled, or aborted are not retrieved.
	 * The search returns an array of activities. Can order on: - &#x60;name&#x60; : the
	 * name of this activity - &#x60;displayName&#x60; : the display name of this activity
	 * - &#x60;state&#x60; : the current state of the activity - &#x60;type&#x60; : the
	 * activity type - &#x60;isTerminal&#x60; : say whether or not the activity is in a
	 * terminal state - &#x60;processId&#x60; : the process this activity is associated to
	 * - &#x60;caseId&#x60; : the process instance initiator this activity is associated
	 * to - &#x60;reached_state_date&#x60; : the date when this activity arrived in this
	 * state Can filter on: - &#x60;supervisor_id&#x60;: retrieve the information the
	 * process manager associated to this id has access to (only in Enterprise editions) -
	 ...
	 * state Can filter on: - &#x60;supervisor_id&#x60;: retrieve the information the
	 * process manager associated to this id has access to (only in Enterprise editions) -
	 * f: same as the sort order fields Note, this is equivalent to the other
	 * <code>searchArchivedActivities</code> method, but with the query parameters
	 ...
	 * {@link SearchArchivedActivitiesQueryParams} class that allows for building up this
	...
	@RequestLine("GET /API/bpm/archivedActivity?p={p}&c={c}&f={f}&o={o}&s={s}")
	@Headers({ "Accept: application/json", })
	List<ArchivedActivity> searchArchivedActivities(@QueryMap(encoded = true) Map<String, Object> queryParams);

	/**
	 * A convenience class for generating query parameters for the
	 * <code>searchArchivedActivities
	 * </code> method in a fluent style.
	 */
	class SearchArchivedActivitiesQueryParams extends HashMap<String, Object> {
