...
public interface GroupApi extends ApiClient.Api {
  ...
  ApiResponse<List<Group>> searchGroupsWithHttpInfo(@Param("p") Integer p, @Param("c") Integer c, @Param("f") List<String> f, @Param("o") String o);
  ...
  * but this one also exposes the Http response headers
   ...
   ApiResponse<List<Group>> searchGroupsWithHttpInfo(@QueryMap(encoded=true) Map<String, Object> queryParams);
