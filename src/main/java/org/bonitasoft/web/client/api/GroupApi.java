...
public interface GroupApi extends ApiClient.Api {
	 ...
	 * Finds Groups Finds Groups with pagination params and filters. - can order on
	 * &#x60;id&#x60;,&#x60;name&#x60;,&#x60;displayName&#x60; - can filter on
	 * &#x60;name&#x60;,&#x60;displayName&#x60;,&#x60;parent_path&#x60; Note, this is
	 * equivalent to the other <code>searchGroups</code> method, but with the query
	 ...
	 * {@link SearchGroupsQueryParams} class that allows for building up this map in a
	 * fluent style.
	 ...
	 */
	class SearchGroupsQueryParams extends HashMap<String, Object> {
