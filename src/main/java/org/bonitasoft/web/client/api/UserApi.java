...
public interface UserApi extends ApiClient.Api {
	...
	/**
	 * Delete the User by ID Delete the single User for the given ID. **Use this method
	 * with caution**: some artifacts like applications, process instances or users may
	 * present display problems in the Bonita Portal if the referenced user was deleted.
	 * Note that you can disable a user instead of deleting it. To do so, use the UPDATE
	 * method and set the attribute &#39;enabled&#39; to false
	...
	/**
	 * Finds Users Finds Users with pagination params and filters - can order on
	 ...
	 * <code>searchUsers</code> method, but with the query parameters collected into a
	 * single Map parameter. This is convenient for services with optional query
	 * parameters, especially when used with the {@link SearchUsersQueryParams} class that
	 ...
	 */
	class SearchUsersQueryParams extends HashMap<String, Object> {
