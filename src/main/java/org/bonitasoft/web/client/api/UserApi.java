...
public interface UserApi extends ApiClient.Api {
  ...
  ApiResponse<List<User>> searchUsersWithHttpInfo(@Param("p") Integer p, @Param("c") Integer c, @Param("f") List<String> f, @Param("o") String o, @Param("s") String s);
  ...
  * but this one also exposes the Http response headers
   ...
   ApiResponse<List<User>> searchUsersWithHttpInfo(@QueryMap(encoded=true) Map<String, Object> queryParams);
