...
public interface HumanTaskApi extends ApiClient.Api {
     ...
     * &#x60;parentActivityInstanceId&#x60;, &#x60;assigneeId&#x60;, &#x60;parentContainerId&#x60;,
     * &#x60;displayName&#x60;, &#x60;reachedStateDate&#x60; - can search on any field that can be
     * used to order results - can filter on &#x60;assigned_id&#x60;, &#x60;state&#x60;,
     * &#x60;name&#x60;, &#x60;displayName&#x60;, &#x60;processDefinitionId&#x60;, &#x60;caseId&#x60;,
    ...
    List<HumanTask> searchHumanTasks(
            @Param("p") Integer p,
            @Param("c") Integer c,
     ...
     * used to order results - can filter on &#x60;assigned_id&#x60;, &#x60;state&#x60;,
     * &#x60;name&#x60;, &#x60;displayName&#x60;, &#x60;processDefinitionId&#x60;, &#x60;caseId&#x60;,
     * &#x60;rootProcessInstanceId&#x60;, &#x60;parentProcessInstanceId&#x60; Note, this is equivalent
     * to the other <code>searchHumanTasks</code> method, but with the query parameters collected into
     * a single Map parameter. This is convenient for services with optional query parameters,
     * especially when used with the {@link SearchHumanTasksQueryParams} class that allows for
    ...
    /**
     * A convenience class for generating query parameters for the <code>searchHumanTasks</code>
     ...
     *
     * @param id ID of the HumanTask to return (required)
     * @param humanTaskUpdateRequest Fields that can be updated are &#x60;assignedId&#x60; and
     *        &#x60;state&#x60;. Specify only those fields that you want to change. (required)
     */
