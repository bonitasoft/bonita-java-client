...
public interface HumanTaskApi extends ApiClient.Api {
    ...
    ApiResponse<List<HumanTask>> searchHumanTasksWithHttpInfo(@Param("p") Integer p, @Param("c") Integer c,
    ...
    List<HumanTask> searchHumanTasks(@QueryMap(encoded = true) SearchHumanTasksQueryParams queryParams);
    ...
    ApiResponse<List<HumanTask>> searchHumanTasksWithHttpInfo(
    ...
    ApiResponse<Void> updateHumanTaskByIdWithHttpInfo(@Param("id") String id,
