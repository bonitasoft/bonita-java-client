...
public interface ArchivedProcessInstanceApi extends ApiClient.Api {
	...
	/**
	 * Delete the ArchivedProcessInstance by ID Delete the single ArchivedProcessInstance
	 * for the given ID
	...
	/**
	 * Finds the ArchivedProcessInstance by ID Returns the single ArchivedProcessInstance
	 * for the given ID
	 ...
	 * @param id ID of the ArchivedProcessInstance that has the Context to return
	 * (required)
	...
	/**
	 * Finds ArchivedProcessInstances Finds archived ProcessInstances (or ProcessInstance)
	 * with pagination params and filters You can order on &#x60;id&#x60;,
	 * &#x60;processDefinitionId&#x60;, &#x60;startedBy&#x60;,
	 * &#x60;startedBySubstitute&#x60;, &#x60;startDate&#x60;, &#x60;endDate&#x60;,
	 * &#x60;lastUpdate&#x60;, &#x60;archivedDate&#x60;, &#x60;sourceObjectId&#x60; You
	 * can filter on : * &#x60;sourceObjectId&#x60;: The original process instance ID
	 * before the process instance was archived * &#x60;processDefinitionId&#x60;: The
	 * process derfinition ID * &#x60;name&#x60;: the process name *
	 * &#x60;started_by&#x60;: the ID of the user who started the process *
	 * &#x60;team_manager_id&#x60;: allow to retrieve the process instances in which all
	 * users with this manager ID ar involved) * &#x60;supervisor_id&#x60;: allow the
	 * retrived the process instances of all processes the user with this ID is supervisor
	 * of) beware you cannot use team_manager_id and supervisor_id at the same time
	 ...
	 * users with this manager ID ar involved) * &#x60;supervisor_id&#x60;: allow the
	 * retrived the process instances of all processes the user with this ID is supervisor
	 * of) beware you cannot use team_manager_id and supervisor_id at the same time Note,
	 * this is equivalent to the other <code>searchArchivedProcessInstances</code> method,
	 ...
	 * the {@link SearchArchivedProcessInstancesQueryParams} class that allows for
	 ...
	 */
	class SearchArchivedProcessInstancesQueryParams extends HashMap<String, Object> {
