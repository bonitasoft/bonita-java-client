...
public interface ArchivedProcessInstanceApi extends ApiClient.Api {
  ...
  List<ArchivedProcessInstance> searchArchivedProcessInstances(@QueryMap(encoded=true) Map<String, Object> queryParams);
  ...
  * but this one also exposes the Http response headers
   ...
   ApiResponse<List<ArchivedProcessInstance>> searchArchivedProcessInstancesWithHttpInfo(@QueryMap(encoded=true) Map<String, Object> queryParams);
