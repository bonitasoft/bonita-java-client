...
public interface ArchivedProcessInstanceApi extends ApiClient.Api {
  ...
  List<ArchivedProcessInstance> searchArchivedProcessInstances(@Param("p") Integer p, @Param("c") Integer c, @Param("f") List<String> f, @Param("o") String o);
  ...
  ApiResponse<List<ArchivedProcessInstance>> searchArchivedProcessInstancesWithHttpInfo(@Param("p") Integer p, @Param("c") Integer c, @Param("f") List<String> f, @Param("o") String o);
  ...
  List<ArchivedProcessInstance> searchArchivedProcessInstances(@QueryMap(encoded=true) SearchArchivedProcessInstancesQueryParams queryParams);
  ...
  * but this one also exposes the Http response headers
   ...
   ApiResponse<List<ArchivedProcessInstance>> searchArchivedProcessInstancesWithHttpInfo(@QueryMap(encoded=true) SearchArchivedProcessInstancesQueryParams queryParams);
