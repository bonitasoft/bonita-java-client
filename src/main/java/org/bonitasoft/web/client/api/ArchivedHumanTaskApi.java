...
public interface ArchivedHumanTaskApi extends ApiClient.Api {
  ...
  List<ArchivedHumanTask> searchArchivedHumanTasks(@QueryMap(encoded=true) SearchArchivedHumanTasksQueryParams queryParams);
  ...
  * but this one also exposes the Http response headers
   ...
   ApiResponse<List<ArchivedHumanTask>> searchArchivedHumanTasksWithHttpInfo(@QueryMap(encoded=true) SearchArchivedHumanTasksQueryParams queryParams);
