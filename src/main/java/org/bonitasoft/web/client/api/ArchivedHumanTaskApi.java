...
public interface ArchivedHumanTaskApi extends ApiClient.Api {
     ...
     * Finds ArchivedHumanTasks with pagination params and filters You can filter on: * &#x60;assigned_id&#x3D;{user_id}&#x60;: retrieve only the human tasks
    ...
    List<ArchivedHumanTask> searchArchivedHumanTasks(@Param("p") Integer p, @Param("c") Integer c,
    ...
    ApiResponse<List<ArchivedHumanTask>> searchArchivedHumanTasksWithHttpInfo(@Param("p") Integer p,
    ...
    List<ArchivedHumanTask> searchArchivedHumanTasks(
            @QueryMap(encoded = true) SearchArchivedHumanTasksQueryParams queryParams);
    ...
    ApiResponse<List<ArchivedHumanTask>> searchArchivedHumanTasksWithHttpInfo(
            @QueryMap(encoded = true) SearchArchivedHumanTasksQueryParams queryParams);
