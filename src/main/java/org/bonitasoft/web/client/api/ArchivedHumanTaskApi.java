...
public interface ArchivedHumanTaskApi extends ApiClient.Api {
  ...
  /**
   * Finds the ArchivedHumanTask by ID Returns the single ArchivedHumanTask for the given ID
   *
  ...
  /**
   * Finds ArchivedHumanTasks Finds ArchivedHumanTasks with pagination params and filters You can
  ...
  List<ArchivedHumanTask> searchArchivedHumanTasks(
      @Param("p") Integer p,
      @Param("c") Integer c,
   ...
   * \&quot;Analyse ProcessInstance\&quot;:
   * &#x60;/API/bpm/archivedHumanTask?p&#x3D;0&amp;c&#x3D;10&amp;f&#x3D;displayName&#x3D;Analyse
   * ProcessInstance&#x60; Note, this is equivalent to the other <code>searchArchivedHumanTasks
   ...
   * SearchArchivedHumanTasksQueryParams} class that allows for building up this map in a fluent
   * style.
   *
  ...
  /**
   * A convenience class for generating query parameters for the <code>searchArchivedHumanTasks
