...
public interface ArchivedHumanTaskApi extends ApiClient.Api {
	...
	/**
	 * Finds the ArchivedHumanTask by ID Returns the single ArchivedHumanTask for the
	 * given ID
	...
	/**
	 * Finds ArchivedHumanTasks Finds ArchivedHumanTasks with pagination params and
	 ...
	 * especially when used with the {@link SearchArchivedHumanTasksQueryParams} class
	 ...
	 */
	class SearchArchivedHumanTasksQueryParams extends HashMap<String, Object> {
