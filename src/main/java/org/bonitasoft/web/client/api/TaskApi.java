...
public interface TaskApi extends ApiClient.Api {
  ...
  ApiResponse<List<Task>> searchTasksWithHttpInfo(@Param("p") Integer p, @Param("c") Integer c, @Param("f") List<String> f, @Param("o") String o);
  ...
  * but this one also exposes the Http response headers
   ...
   ApiResponse<List<Task>> searchTasksWithHttpInfo(@QueryMap(encoded=true) Map<String, Object> queryParams);
