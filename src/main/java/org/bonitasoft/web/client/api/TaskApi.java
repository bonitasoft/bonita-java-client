...
public interface TaskApi extends ApiClient.Api {
	...
	/**
	 * Finds Tasks Finds Tasks with pagination params and filters - can order on
	 * &#x60;caseId&#x60;, &#x60;processId&#x60;, &#x60;state&#x60;, &#x60;type&#x60;,
	 * &#x60;supervisor_id&#x60;, &#x60;last_update_date&#x60; - can filter on
	 * &#x60;caseId&#x60;, &#x60;processId&#x60;, &#x60;state&#x60;, &#x60;type&#x60;,
	 ...
	 * &#x60;supervisor_id&#x60;, &#x60;last_update_date&#x60; - can filter on
	 * &#x60;caseId&#x60;, &#x60;processId&#x60;, &#x60;state&#x60;, &#x60;type&#x60;,
	 * &#x60;supervisor_id&#x60;, &#x60;last_update_date&#x60; Note, this is equivalent to
	 * the other <code>searchTasks</code> method, but with the query parameters collected
	 * into a single Map parameter. This is convenient for services with optional query
	 * parameters, especially when used with the {@link SearchTasksQueryParams} class that
	 ...
	 * @param id ID of the Task to return (required)
	 * @param requestBody Task fields to update (forbidden fields are :
	 * &#x60;caseId&#x60;, &#x60;processId&#x60;, &#x60;name&#x60;,
	 * &#x60;executedBy&#x60;, &#x60;type&#x60;, &#x60;id&#x60;,
	 * &#x60;reached_state_date&#x60;, &#x60;last_update_date&#x60;) (required)
	 */
	 ...
	 */
	class SearchTasksQueryParams extends HashMap<String, Object> {
