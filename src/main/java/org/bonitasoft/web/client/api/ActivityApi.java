...
public interface ActivityApi extends ApiClient.Api {
  ...
  /**
   * Finds Activities Finds Activities with pagination params and filters. Activities in states
   * completed, cancelled, or aborted are not retrieved. The search returns an array of activities.
   * - can order on &#x60;name&#x60;, &#x60;displayName&#x60;, &#x60;state&#x60;,
   * &#x60;processDefinitionId&#x60;, &#x60;parentProcessInstanceId&#x60;,
   * &#x60;parentActivityInstanceId&#x60; (order by parent activity id),
   * &#x60;rootProcessInstanceId&#x60;, &#x60;lastUpdateDate&#x60; - can search on &#x60;name&#x60;,
   * &#x60;displayName&#x60;, &#x60;state&#x60;, &#x60;processDefinitionId&#x60;,
   * &#x60;parentProcessInstanceId&#x60;, &#x60;parentActivityInstanceId&#x60; (order by parent
   * activity id), &#x60;rootProcessInstanceId&#x60;, &#x60;lastUpdateDate&#x60; - can filter on
   * &#x60;name&#x60;, &#x60;state&#x60;, &#x60;processId&#x60;,
   * &#x60;parentProcessInstanceId&#x60;, &#x60;rootProcessInstanceId&#x60;,
   * &#x60;last_update_date&#x60;, &#x60;supervisor_id&#x60; (only in Enterprise editions)
   *
   ...
   * &#x60;name&#x60;, &#x60;state&#x60;, &#x60;processId&#x60;,
   * &#x60;parentProcessInstanceId&#x60;, &#x60;rootProcessInstanceId&#x60;,
   * &#x60;last_update_date&#x60;, &#x60;supervisor_id&#x60; (only in Enterprise editions) Note,
   * this is equivalent to the other <code>searchActivities</code> method, but with the query
   * parameters collected into a single Map parameter. This is convenient for services with optional
   * query parameters, especially when used with the {@link SearchActivitiesQueryParams} class that
  ...
  /**
   * A convenience class for generating query parameters for the <code>searchActivities</code>
