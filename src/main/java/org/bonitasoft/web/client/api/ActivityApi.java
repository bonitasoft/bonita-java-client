...
public interface ActivityApi extends ApiClient.Api {
	...
	/**
	 * Finds Activities Finds Activities with pagination params and filters. Activities in
	 * states completed, cancelled, or aborted are not retrieved. The search returns an
	 * array of activities. - can order on &#x60;name&#x60;, &#x60;displayName&#x60;,
	 * &#x60;state&#x60;, &#x60;processDefinitionId&#x60;,
	 * &#x60;parentProcessInstanceId&#x60;, &#x60;parentActivityInstanceId&#x60; (order by
	 * parent activity id), &#x60;rootProcessInstanceId&#x60;, &#x60;lastUpdateDate&#x60;
	 * - can search on &#x60;name&#x60;, &#x60;displayName&#x60;, &#x60;state&#x60;,
	 * &#x60;processDefinitionId&#x60;, &#x60;parentProcessInstanceId&#x60;,
	 * &#x60;parentActivityInstanceId&#x60; (order by parent activity id),
	 * &#x60;rootProcessInstanceId&#x60;, &#x60;lastUpdateDate&#x60; - can filter on
	 ...
	 * &#x60;parentProcessInstanceId&#x60;, &#x60;rootProcessInstanceId&#x60;,
	 * &#x60;last_update_date&#x60;, &#x60;supervisor_id&#x60; (only in Enterprise
	 * editions) Note, this is equivalent to the other <code>searchActivities</code>
	 ...
	 * with the {@link SearchActivitiesQueryParams} class that allows for building up this
	 ...
	 */
	class SearchActivitiesQueryParams extends HashMap<String, Object> {
