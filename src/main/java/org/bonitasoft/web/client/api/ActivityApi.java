...
public interface ActivityApi extends ApiClient.Api {
  ...
  ApiResponse<List<Activity>> searchActivitiesWithHttpInfo(@Param("p") Integer p, @Param("c") Integer c, @Param("f") List<String> f, @Param("o") String o, @Param("s") String s);
  ...
  * but this one also exposes the Http response headers
   ...
   ApiResponse<List<Activity>> searchActivitiesWithHttpInfo(@QueryMap(encoded=true) SearchActivitiesQueryParams queryParams);
  ...
  ApiResponse<Void> updateActivityByIdWithHttpInfo(@Param("id") String id, ActivityUpdateRequest activityUpdateRequest);
