...
public interface ProcessParameterApi extends ApiClient.Api {
    ...
    ApiResponse<ProcessParameter> getProcessParameterByIdWithHttpInfo(@Param("id") String id,
    ...
    List<ProcessParameter> searchProcessParameters(@Param("p") Integer p, @Param("c") Integer c,
    ...
    ApiResponse<List<ProcessParameter>> searchProcessParametersWithHttpInfo(@Param("p") Integer p,
    ...
    ApiResponse<List<ProcessParameter>> searchProcessParametersWithHttpInfo(
            @QueryMap(encoded = true) SearchProcessParametersQueryParams queryParams);
    ...
    ApiResponse<Void> updateProcessParameterByIdWithHttpInfo(@Param("id") String id, @Param("name") String name,
            ProcessParameterUpdateRequest processParameterUpdateRequest);
