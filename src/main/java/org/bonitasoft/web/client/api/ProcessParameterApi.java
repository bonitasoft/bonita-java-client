...
public interface ProcessParameterApi extends ApiClient.Api {
	...
	/**
	 * Finds the ProcessParameter by ID Returns the single ProcessParameter for the given
	 * ID
	 ...
	 * the {@link SearchProcessParametersQueryParams} class that allows for building up
	 ...
	 * ![edition](https://img.shields.io/badge/edition-entreprise-blue) Update the
	 * ProcessParameter for the given ID
	 * @param id ID of the process to get parameter from (required)
	 * @param name Name of the process parameter to return (required)
	 * @param processParameterUpdateRequest You can update only a process parameter value
	 * using the API. If you specify values for other fields in the update request, they
	 ...
	 * <code>searchProcessParameters
	 * </code> method in a fluent style.
	 */
	class SearchProcessParametersQueryParams extends HashMap<String, Object> {
