...
public interface ProcessParameterApi extends ApiClient.Api {
  ...
  List<ProcessParameter> searchProcessParameters(@QueryMap(encoded=true) Map<String, Object> queryParams);
  ...
  * but this one also exposes the Http response headers
   ...
   ApiResponse<List<ProcessParameter>> searchProcessParametersWithHttpInfo(@QueryMap(encoded=true) Map<String, Object> queryParams);
