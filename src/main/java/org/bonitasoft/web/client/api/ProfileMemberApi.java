...
public interface ProfileMemberApi extends ApiClient.Api {
  ...
  ApiResponse<List<ProfileMember>> searchProfileMembersWithHttpInfo(@Param("p") Integer p, @Param("c") Integer c, @Param("f") List<String> f);
  ...
  * but this one also exposes the Http response headers
   ...
   ApiResponse<List<ProfileMember>> searchProfileMembersWithHttpInfo(@QueryMap(encoded=true) Map<String, Object> queryParams);
