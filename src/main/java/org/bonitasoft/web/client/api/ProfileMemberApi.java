...
public interface ProfileMemberApi extends ApiClient.Api {
	...
	/**
	 * Finds ProfileMembers Finds ProfileMembers with pagination params and filters
	 * **Filter &#x60;member_type&#x60; is mandatory** You can filter on
	 * &#x60;profile_id&#x60;, &#x60;user_id&#x60;, &#x60;role_id&#x60; and
	 * &#x60;group_id&#x60;
	 ...
	 * **Filter &#x60;member_type&#x60; is mandatory** You can filter on
	 * &#x60;profile_id&#x60;, &#x60;user_id&#x60;, &#x60;role_id&#x60; and
	 * &#x60;group_id&#x60; Note, this is equivalent to the other
	 * <code>searchProfileMembers</code> method, but with the query parameters collected
	 * into a single Map parameter. This is convenient for services with optional query
	 * parameters, especially when used with the {@link SearchProfileMembersQueryParams}
	...
	@RequestLine("GET /API/portal/profileMember?p={p}&c={c}&f={f}")
	@Headers({ "Accept: application/json", })
	List<ProfileMember> searchProfileMembers(@QueryMap(encoded = true) Map<String, Object> queryParams);

	/**
	 * A convenience class for generating query parameters for the
	 * <code>searchProfileMembers</code> method in a fluent style.
	 */
	class SearchProfileMembersQueryParams extends HashMap<String, Object> {
