...
public interface ProcessApi extends ApiClient.Api {
    ...
    ApiResponse<List<ProcessDefinition>> searchProcessesWithHttpInfo(@Param("p") Integer p, @Param("c") Integer c,
    ...
    List<ProcessDefinition> searchProcesses(@QueryMap(encoded = true) SearchProcessesQueryParams queryParams);
    ...
    ApiResponse<List<ProcessDefinition>> searchProcessesWithHttpInfo(
    ...
    ApiResponse<Void> updateProcessConnectorByProcessIdWithHttpInfo(@Param("id") String id,
