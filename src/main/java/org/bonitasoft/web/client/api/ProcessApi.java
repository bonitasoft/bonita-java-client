...
public interface ProcessApi extends ApiClient.Api {
    ...
    /**
     * Create the Process Create the Process. A process resource is created using the content of a
     * .bar file that has previously been uploaded, using the [processUpload
    ...
    /**
     * Delete the Process by ID Delete the single Process for the given ID. **Warning: Beware! Data
     * loss risk!** Deleting a process will automatically delete all its process instances (on-going
     * and archived alike). Thus, the operation may take a long time, and fail if the transaction
     * timeout is not large enough. This feature should only be used on non-production environments.
    ...
    /**
     * Delete the Process by IDs Delete Process for the given list of ID. **Warning: Beware! Data loss
     * risk!** Deleting a process will automatically delete all its process instances (on-going and
     * archived alike). Thus, the operation may take a long time, and fail if the transaction timeout
     * is not large enough. This feature should only be used on non-production environments. **Please
    ...
    /**
     * Finds Processes Finds Processes with pagination params and filters - can order (default is ASC)
     * on &#x60;name&#x60;, &#x60;version&#x60;, &#x60;deploymentDate&#x60;, &#x60;deployedBy&#x60;,
     * &#x60;activationState&#x60;, &#x60;configurationState&#x60;, &#x60;processId&#x60;,
     * &#x60;displayName&#x60;, &#x60;lastUpdateDate&#x60;, &#x60;categoryId&#x60;, &#x60;label&#x60;
     * - can search on &#x60;name&#x60;, &#x60;displayName&#x60; or &#x60;version&#x60; - can filter
     * on &#x60;name&#x60;, &#x60;version&#x60;, &#x60;deploymentDate&#x60;, &#x60;deployedBy&#x60;,
     * &#x60;activationState&#x60; with the value DISABLED or ENABLED, &#x60;configurationState&#x60;
     * with the value UNRESOLVED, or RESOLVED, &#x60;processId&#x60;, &#x60;displayName&#x60;,
     * &#x60;lastUpdateDate&#x60;, &#x60;categoryId&#x60;, &#x60;label&#x60;,
     * &#x60;supervisor_id&#x60;
     *
    ...
    List<ProcessDefinition> searchProcesses(
            @Param("p") Integer p,
            @Param("c") Integer c,
     ...
     * with the value UNRESOLVED, or RESOLVED, &#x60;processId&#x60;, &#x60;displayName&#x60;,
     * &#x60;lastUpdateDate&#x60;, &#x60;categoryId&#x60;, &#x60;label&#x60;,
     * &#x60;supervisor_id&#x60; Note, this is equivalent to the other <code>searchProcesses</code>
     ...
     * SearchProcessesQueryParams} class that allows for building up this map in a fluent style.
     *
    ...
    /**
     * A convenience class for generating query parameters for the <code>searchProcesses</code> method
     * in a fluent style.
     */
