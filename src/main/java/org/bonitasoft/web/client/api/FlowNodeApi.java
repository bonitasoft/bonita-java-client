...
public interface FlowNodeApi extends ApiClient.Api {
  ...
  ApiResponse<List<FlowNode>> searchFlowNodesWithHttpInfo(@Param("p") Integer p, @Param("c") Integer c, @Param("f") List<String> f, @Param("o") String o, @Param("s") String s);
  ...
  * but this one also exposes the Http response headers
   ...
   ApiResponse<List<FlowNode>> searchFlowNodesWithHttpInfo(@QueryMap(encoded=true) SearchFlowNodesQueryParams queryParams);
  ...
  ApiResponse<Void> updateFlowNodeByIdWithHttpInfo(@Param("id") String id, FlowNodeUpdateRequest flowNodeUpdateRequest);
