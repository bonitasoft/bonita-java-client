...
public interface FlowNodeApi extends ApiClient.Api {
	 ...
	 * &#x60;parentActivityInstanceId&#x60; (if the retrieved flow nodes are activities,
	 * order by parent activity id), &#x60;rootProcessInstanceId&#x60;,
	 * &#x60;lastUpdateDate&#x60; - can search on any field that can be used to order
	 * results - can filter on &#x60;name&#x60;, &#x60;state&#x60;, &#x60;processId&#x60;,
	 ...
	 * results - can filter on &#x60;name&#x60;, &#x60;state&#x60;, &#x60;processId&#x60;,
	 * &#x60;parentProcessInstanceId&#x60;, &#x60;rootProcessInstanceId&#x60;,
	 * &#x60;last_update_date&#x60; Note, this is equivalent to the other
	 * <code>searchFlowNodes</code> method, but with the query parameters collected into a
	 * single Map parameter. This is convenient for services with optional query
	 * parameters, especially when used with the {@link SearchFlowNodesQueryParams} class
	 ...
	 * ![edition](https://img.shields.io/badge/edition-entreprise-blue) Replay the flow
	 ...
	 */
	class SearchFlowNodesQueryParams extends HashMap<String, Object> {
