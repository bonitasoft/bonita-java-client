...
public interface ActorApi extends ApiClient.Api {
	...
	/**
	 * Finds Actors Finds Actors with pagination params and filters Note, this is
	 * equivalent to the other <code>searchActors</code> method, but with the query
	 ...
	 * {@link SearchActorsQueryParams} class that allows for building up this map in a
	 * fluent style.
	 ...
	 */
	class SearchActorsQueryParams extends HashMap<String, Object> {
