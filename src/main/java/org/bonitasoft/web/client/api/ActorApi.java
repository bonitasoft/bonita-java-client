...
public interface ActorApi extends ApiClient.Api {
  ...
  ApiResponse<List<Actor>> searchActorsWithHttpInfo(@Param("p") Integer p, @Param("c") Integer c, @Param("f") List<String> f, @Param("o") String o);
  ...
  * but this one also exposes the Http response headers
   ...
   ApiResponse<List<Actor>> searchActorsWithHttpInfo(@QueryMap(encoded=true) Map<String, Object> queryParams);
