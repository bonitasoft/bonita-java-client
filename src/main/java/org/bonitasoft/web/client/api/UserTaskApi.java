...
public interface UserTaskApi extends ApiClient.Api {
	...
	/**
	 * Execute the UserTask Execute the UserTask. In order to execute a task, the task
	 * contract values have to be provided.
	 * @param id ID of the UserTask to execute (required)
	 * @param body A JSON object matching task contract. Execute a task providing correct
	 * contract values. (required)
	 * @param assign if true, assign the task to the current user and execute the task
	 * (optional)
	 */
	...
	/**
	 * Execute the UserTask Execute the UserTask. In order to execute a task, the task
	 * contract values have to be provided. Note, this is equivalent to the other
	 * <code>executeUserTask</code> method, but with the query parameters collected into a
	 * single Map parameter. This is convenient for services with optional query
	 * parameters, especially when used with the {@link ExecuteUserTaskQueryParams} class
	 ...
	 * <ul>
	 * <li>assign - if true, assign the task to the current user and execute the task
	 * (optional)
	 * </ul>
	 */
	@RequestLine("POST /API/bpm/userTask/{id}/execution?assign={assign}")
	 ...
	 * &#x60;id&#x60; - can search on &#x60;displayName&#x60; - can filter on
	 * &#x60;displayName&#x60;
	 ...
	 * Finds UserTasks Finds UserTasks with pagination params and filters - can order on
	 * &#x60;id&#x60; - can search on &#x60;displayName&#x60; - can filter on
	 * &#x60;displayName&#x60; Note, this is equivalent to the other
	 * <code>searchUserTasks</code> method, but with the query parameters collected into a
	 * single Map parameter. This is convenient for services with optional query
	 * parameters, especially when used with the {@link SearchUserTasksQueryParams} class
	 * that allows for building up this map in a fluent style.
	 * @param queryParams Map of query parameters as name-value pairs
	 * <p>
	 * The following elements may be specified in the query map:
	...
	/**
	 * Update the UserTask by ID Update the UserTask for the given ID. Fields that can be
	 * updated are &#x60;assigned_id&#x60; and &#x60;state&#x60;. The only value that can
	 * be set for the state is &#x60;skipped&#x60;. You only need to specify the fields
	 ...
	 */
	class ExecuteUserTaskQueryParams extends HashMap<String, Object> {
	 ...
	 */
	class SearchUserTasksQueryParams extends HashMap<String, Object> {
