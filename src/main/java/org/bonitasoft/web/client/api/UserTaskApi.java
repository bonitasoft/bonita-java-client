...
public interface UserTaskApi extends ApiClient.Api {
	...
	ApiResponse<Void> executeUserTaskWithHttpInfo(@Param("id") String id, Map<String, Object> body, @QueryMap(encoded = true) Map<String, Object> queryParams);
	...
	ApiResponse<List<UserTask>> searchUserTasksWithHttpInfo(@QueryMap(encoded = true) Map<String, Object> queryParams);
