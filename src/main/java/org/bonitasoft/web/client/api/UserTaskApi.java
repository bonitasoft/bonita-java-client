...
public interface UserTaskApi extends ApiClient.Api {
  ...
  ApiResponse<Void> executeUserTaskWithHttpInfo(@Param("id") String id, Map<String, Object> body, @Param("assign") Boolean assign);
  ...
  void executeUserTask(@Param("id") String id, Map<String, Object> body, @QueryMap(encoded=true) ExecuteUserTaskQueryParams queryParams);
  ...
  * but this one also exposes the Http response headers
   ...
   ApiResponse<Void> executeUserTaskWithHttpInfo(@Param("id") String id, Map<String, Object> body, @QueryMap(encoded=true) ExecuteUserTaskQueryParams queryParams);
  ...
  ApiResponse<List<UserTask>> searchUserTasksWithHttpInfo(@Param("p") Integer p, @Param("c") Integer c, @Param("f") List<String> f, @Param("o") String o, @Param("s") String s);
  ...
  * but this one also exposes the Http response headers
   ...
   ApiResponse<List<UserTask>> searchUserTasksWithHttpInfo(@QueryMap(encoded=true) SearchUserTasksQueryParams queryParams);
  ...
  ApiResponse<Void> updateUserTaskByIdWithHttpInfo(@Param("id") String id, UserTaskUpdateRequest userTaskUpdateRequest);
