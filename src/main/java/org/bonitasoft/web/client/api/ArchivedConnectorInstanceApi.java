...
public interface ArchivedConnectorInstanceApi extends ApiClient.Api {
	...
	/**
	 * Finds ArchivedConnectorInstances Finds ArchivedConnectorInstances with pagination
	 * params and filters
	 ...
	 * <code>searchArchivedConnectorInstances</code> method, but with the query parameters
	 ...
	 * {@link SearchArchivedConnectorInstancesQueryParams} class that allows for building
	 ...
	 * searchArchivedConnectorInstances</code> method in a fluent style.
	 */
	class SearchArchivedConnectorInstancesQueryParams extends HashMap<String, Object> {
