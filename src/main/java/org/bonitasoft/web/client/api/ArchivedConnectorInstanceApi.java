...
public interface ArchivedConnectorInstanceApi extends ApiClient.Api {
  ...
  List<ArchivedConnectorInstance> searchArchivedConnectorInstances(@QueryMap(encoded=true) SearchArchivedConnectorInstancesQueryParams queryParams);
  ...
  * but this one also exposes the Http response headers
   ...
   ApiResponse<List<ArchivedConnectorInstance>> searchArchivedConnectorInstancesWithHttpInfo(@QueryMap(encoded=true) SearchArchivedConnectorInstancesQueryParams queryParams);
