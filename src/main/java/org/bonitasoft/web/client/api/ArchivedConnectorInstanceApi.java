...
public interface ArchivedConnectorInstanceApi extends ApiClient.Api {
    ...
    /**
     * Finds ArchivedConnectorInstances Finds ArchivedConnectorInstances with pagination params and
     * filters
     *
    ...
    /**
     * Finds ArchivedConnectorInstances Finds ArchivedConnectorInstances with pagination params and
     * filters Note, this is equivalent to the other <code>searchArchivedConnectorInstances</code>
     ...
     * SearchArchivedConnectorInstancesQueryParams} class that allows for building up this map in a
     * fluent style.
     *
