...
public interface TimerEventTriggerApi extends ApiClient.Api {
  ...
  List<TimerEventTrigger> searchTimerEventTriggers(@QueryMap(encoded=true) SearchTimerEventTriggersQueryParams queryParams);
  ...
  * but this one also exposes the Http response headers
   ...
   ApiResponse<List<TimerEventTrigger>> searchTimerEventTriggersWithHttpInfo(@QueryMap(encoded=true) SearchTimerEventTriggersQueryParams queryParams);
