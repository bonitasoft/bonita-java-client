...
public interface TimerEventTriggerApi extends ApiClient.Api {
	...
	/**
	 * Finds the TimerEventTrigger by ID Returns the single TimerEventTrigger for the
	 * given ID
	...
	/**
	 * Finds TimerEventTriggers Finds TimerEventTriggers with pagination params and
	 * filters - can order on &#x60;id&#x60; - can search on &#x60;displayName&#x60; - can
	 ...
	 * Finds TimerEventTriggers Finds TimerEventTriggers with pagination params and
	 * filters - can order on &#x60;id&#x60; - can search on &#x60;displayName&#x60; - can
	 * filter on &#x60;displayName&#x60; Note, this is equivalent to the other
	 * <code>searchTimerEventTriggers
	 ...
	 * especially when used with the {@link SearchTimerEventTriggersQueryParams} class
	 ...
	 * <li>caseId - the process instance id (required)
	 * </ul>
	 * @return List&lt;TimerEventTrigger&gt;
	 */
	@RequestLine("GET /API/bpm/timerEventTrigger?p={p}&c={c}&f={f}&o={o}&s={s}&caseId={caseId}")
	 ...
	 * @param id ID of the TimerEventTrigger to return (required)
	 * @param timerEventTriggerUpdateRequest a long value with attribute name
	 ...
	 */
	class SearchTimerEventTriggersQueryParams extends HashMap<String, Object> {
