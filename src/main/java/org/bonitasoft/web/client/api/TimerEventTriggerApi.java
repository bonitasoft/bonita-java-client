...
public interface TimerEventTriggerApi extends ApiClient.Api {
  ...
  /**
   * Finds TimerEventTriggers Finds TimerEventTriggers with pagination params and filters - can
   * order on &#x60;id&#x60; - can search on &#x60;displayName&#x60; - can filter on
   * &#x60;displayName&#x60;
   *
   ...
   * Finds TimerEventTriggers Finds TimerEventTriggers with pagination params and filters - can
   * order on &#x60;id&#x60; - can search on &#x60;displayName&#x60; - can filter on
   * &#x60;displayName&#x60; Note, this is equivalent to the other <code>searchTimerEventTriggers
   ...
   * SearchTimerEventTriggersQueryParams} class that allows for building up this map in a fluent
   * style.
   *
  ...
  /**
   * A convenience class for generating query parameters for the <code>searchTimerEventTriggers
  ...
  TimerEventTriggerUpdateResponse updateTimerEventTriggerById(
      @Param("id") String id, TimerEventTriggerUpdateRequest timerEventTriggerUpdateRequest);
}
