...
public interface TimerEventTriggerApi extends ApiClient.Api {
     ...
     * Finds TimerEventTriggers with pagination params and filters - can order on &#x60;id&#x60; - can search on &#x60;displayName&#x60; - can filter on
     * &#x60;displayName&#x60;
     * 
    ...
    List<TimerEventTrigger> searchTimerEventTriggers(@Param("p") Integer p, @Param("c") Integer c,
            @Param("caseId") String caseId, @Param("f") List<String> f, @Param("o") String o, @Param("s") String s);
    ...
    ApiResponse<List<TimerEventTrigger>> searchTimerEventTriggersWithHttpInfo(@Param("p") Integer p,
            @Param("c") Integer c, @Param("caseId") String caseId, @Param("f") List<String> f, @Param("o") String o,
            @Param("s") String s);
    ...
    List<TimerEventTrigger> searchTimerEventTriggers(
            @QueryMap(encoded = true) SearchTimerEventTriggersQueryParams queryParams);
    ...
    ApiResponse<List<TimerEventTrigger>> searchTimerEventTriggersWithHttpInfo(
            @QueryMap(encoded = true) SearchTimerEventTriggersQueryParams queryParams);
    ...
    TimerEventTriggerUpdateResponse updateTimerEventTriggerById(@Param("id") String id,
    ...
    ApiResponse<TimerEventTriggerUpdateResponse> updateTimerEventTriggerByIdWithHttpInfo(@Param("id") String id,
            TimerEventTriggerUpdateRequest timerEventTriggerUpdateRequest);
