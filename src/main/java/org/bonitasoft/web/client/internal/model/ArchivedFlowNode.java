...
public class ArchivedFlowNode implements Serializable {
  ...
  **/
  ...
  public ArchivedFlowNode executedBySubstitute(String executedBySubstitute) {
   ...
   /**
   * the id of the user who really performed this flow node in case where a substitute did it, or 0 if the flow node was not performed by a substitute
  ...
  **/
  ...
  public ArchivedFlowNode caseId(String caseId) {
   ...
   /**
   * the case id that is associated with this flow node
   * @return caseId
  **/
  @javax.annotation.Nullable
  ...
  public ArchivedFlowNode parentCaseId(String parentCaseId) {
   ...
   /**
   * the parent case id that is associated with this flow node&#39;s case
   * @return parentCaseId
  **/
  @javax.annotation.Nullable
  ...
  public ArchivedFlowNode rootCaseId(String rootCaseId) {
   ...
   /**
   * the root case initiator id that is associated with this flow node&#39;s case
   * @return rootCaseId
  **/
  @javax.annotation.Nullable
  ...
  **/
  ...
  public ArchivedFlowNode rootContainerId(String rootContainerId) {
   ...
   /**
   * the root process id of the root case that is associated with this flow node
  ...
  **/
  ...
  public ArchivedFlowNode parentTaskIdDoubleQuote(String parentTaskIdDoubleQuote) {
   ...
   /**
   * in the case of a subtask, the parent task id 
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(id, displayDescription, executedBySubstitute, caseId, parentCaseId, rootCaseId, processId, rootContainerId, state, type, assignedId, assignedDate, executedBy, priority, actorId, description, name, reachedStateDate, displayName, dueDate, lastUpdateDate, parentTaskIdDoubleQuote, sourceObjectId, archivedDate);
  }
