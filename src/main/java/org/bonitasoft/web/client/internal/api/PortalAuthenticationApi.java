...
public interface PortalAuthenticationApi extends ApiClient.Api {
  ...
  Response login(@Param("username") String username, @Param("password") String password, @Param("tenant") String tenant, @Param("redirect") String redirect, @Param("redirectURL") String redirectURL);
