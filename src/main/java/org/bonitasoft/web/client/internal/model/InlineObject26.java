...
public class InlineObject26 implements Serializable {
  ...
  public InlineObject26 name(String name) {
  ...
  **/
  ...
  public InlineObject26 displayName(String displayName) {
  ...
  **/
  ...
  public InlineObject26 parentPath(String parentPath) {
  ...
  **/
  ...
  public InlineObject26 path(String path) {
  ...
  **/
  ...
  public InlineObject26 description(String description) {
  ...
  **/
  ...
  public InlineObject26 icon(String icon) {
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    return Objects.equals(this.name, inlineObject26.name) &&
        Objects.equals(this.displayName, inlineObject26.displayName) &&
        Objects.equals(this.parentPath, inlineObject26.parentPath) &&
        Objects.equals(this.path, inlineObject26.path) &&
        Objects.equals(this.description, inlineObject26.description) &&
        Objects.equals(this.icon, inlineObject26.icon);
  }
