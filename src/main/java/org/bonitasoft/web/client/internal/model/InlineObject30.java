...
public class InlineObject30 implements Serializable {
  ...
  public InlineObject30 name(String name) {
  ...
  **/
  ...
  public InlineObject30 displayName(String displayName) {
  ...
  **/
  ...
  public InlineObject30 description(String description) {
  ...
  **/
  ...
  public InlineObject30 icon(String icon) {
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    return Objects.equals(this.name, inlineObject30.name) &&
        Objects.equals(this.displayName, inlineObject30.displayName) &&
        Objects.equals(this.description, inlineObject30.description) &&
        Objects.equals(this.icon, inlineObject30.icon);
  }
