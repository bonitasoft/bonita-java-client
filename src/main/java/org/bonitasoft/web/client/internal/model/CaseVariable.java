...
public class CaseVariable implements Serializable {
  ...
  public CaseVariable description(String description) {
  ...
  **/
  ...
  public CaseVariable name(String name) {
  ...
  **/
  ...
  public CaseVariable value(String value) {
   ...
   /**
   * the current value of the case variable
   * @return value
  **/
  @javax.annotation.Nullable
  ...
  public CaseVariable caseId(String caseId) {
  ...
  **/
  ...
  public CaseVariable type(String type) {
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    CaseVariable caseVariable = (CaseVariable) o;
    return Objects.equals(this.description, caseVariable.description) &&
        Objects.equals(this.name, caseVariable.name) &&
        Objects.equals(this.value, caseVariable.value) &&
        Objects.equals(this.caseId, caseVariable.caseId) &&
        Objects.equals(this.type, caseVariable.type);
  }
