...
public interface ArchivedManualTaskApi {
  /**
   ...
   * @return Call&lt;List&lt;ArchivedManualTask&gt;&gt;
   */
  @GET("API/bpm/archivedManualTask")
  Call<List<ArchivedManualTask>> findArchivedManualTasks(
   ...
   * @return Call&lt;ArchivedManualTask&gt;
   */
  @GET("API/bpm/archivedManualTask/{id}")
  Call<ArchivedManualTask> getArchivedManualTaskById(
