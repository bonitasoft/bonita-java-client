 ...
 */
@JsonPropertyOrder({
  CaseDocumentUpdateRequest.JSON_PROPERTY_FILE,
  CaseDocumentUpdateRequest.JSON_PROPERTY_URL,
  CaseDocumentUpdateRequest.JSON_PROPERTY_NAME,
  CaseDocumentUpdateRequest.JSON_PROPERTY_FILE_NAME,
  CaseDocumentUpdateRequest.JSON_PROPERTY_DESCRIPTION
})
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2020-10-01T10:13:11.246508+02:00[Europe/Paris]")
public class CaseDocumentUpdateRequest implements Serializable {
  ...
  public CaseDocumentUpdateRequest file(String file) {
  ...
  **/
  ...
  public CaseDocumentUpdateRequest url(String url) {
  ...
  **/
  ...
  public CaseDocumentUpdateRequest name(String name) {
  ...
  **/
  ...
  public CaseDocumentUpdateRequest fileName(String fileName) {
  ...
  **/
  ...
  public CaseDocumentUpdateRequest description(String description) {
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    CaseDocumentUpdateRequest caseDocumentUpdateRequest = (CaseDocumentUpdateRequest) o;
    return Objects.equals(this.file, caseDocumentUpdateRequest.file) &&
        Objects.equals(this.url, caseDocumentUpdateRequest.url) &&
        Objects.equals(this.name, caseDocumentUpdateRequest.name) &&
        Objects.equals(this.fileName, caseDocumentUpdateRequest.fileName) &&
        Objects.equals(this.description, caseDocumentUpdateRequest.description);
  }
  ...
  public String toString() {
    ...
    sb.append("class CaseDocumentUpdateRequest {\n");
