...
public class APIBpmCaseVariables implements Serializable {
  ...
  public APIBpmCaseVariables name(String name) {
  ...
  **/
  ...
  public APIBpmCaseVariables value(Map<String, Object> value) {
    
    this.value = value;
    return this;
  }

  public APIBpmCaseVariables putValueItem(String key, Object valueItem) {
    if (this.value == null) {
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    APIBpmCaseVariables aPIBpmCaseVariables = (APIBpmCaseVariables) o;
    return Objects.equals(this.name, aPIBpmCaseVariables.name) &&
        Objects.equals(this.value, aPIBpmCaseVariables.value);
  }
  ...
  public String toString() {
    ...
    sb.append("class APIBpmCaseVariables {\n");
