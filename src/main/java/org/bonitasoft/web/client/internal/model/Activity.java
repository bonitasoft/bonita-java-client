...
public class Activity implements Serializable {
  ...
  **/
  ...
  public Activity processId(String processId) {
   ...
   /**
   * the process definition id of the case which define this activity
   * @return processId
  **/
  @javax.annotation.Nullable
  ...
  public Activity parentCaseId(String parentCaseId) {
   ...
   /**
   * the immediate containing case id (long, a.k.a process instance id)
   * @return parentCaseId
  **/
  @javax.annotation.Nullable
  ...
  public Activity rootCaseId(String rootCaseId) {
   ...
   /**
   * the top/root case id (long, a.k.a process instance id). In the case of an event sub process, parentCaseId will the id of the case called while rootCaseId will be the one from the caller case
   * @return rootCaseId
  **/
  @javax.annotation.Nullable
  ...
  **/
  ...
  public Activity executedBySubstitute(String executedBySubstitute) {
   ...
   /**
   * the id of the user who did actually performed the activity in the case of has been done in the name of someone else. Value is 0 otherwise
