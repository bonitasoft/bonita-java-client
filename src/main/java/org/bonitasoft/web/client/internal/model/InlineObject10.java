...
public class InlineObject10 implements Serializable {
  ...
  public InlineObject10 displayName(String displayName) {
   ...
   /**
   * display name of the UserTask
   * @return displayName
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "display name of the UserTask")
  ...
  public InlineObject10 token(String token) {
   ...
   /**
   * token of the UserTask used to build the UserTask URL
   * @return token
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "token of the UserTask used to build the UserTask URL")
  ...
  public boolean equals(java.lang.Object o) {
    ...
    return Objects.equals(this.displayName, inlineObject10.displayName) &&
        Objects.equals(this.token, inlineObject10.token);
  }
