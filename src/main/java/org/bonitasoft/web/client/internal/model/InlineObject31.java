...
public class InlineObject31 implements Serializable {
  ...
  public InlineObject31 displayName(String displayName) {
  ...
  **/
  ...
  public InlineObject31 token(String token) {
   ...
   /**
   * token of the User used to build the User URL
   * @return token
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "token of the User used to build the User URL")
  ...
  public boolean equals(java.lang.Object o) {
    ...
    return Objects.equals(this.displayName, inlineObject31.displayName) &&
        Objects.equals(this.token, inlineObject31.token);
  }
