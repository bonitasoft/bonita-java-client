...
public class InlineObject29 implements Serializable {
  ...
  public InlineObject29 name(String name) {
  ...
  **/
  ...
  public InlineObject29 displayName(String displayName) {
  ...
  **/
  ...
  public InlineObject29 description(String description) {
  ...
  **/
  ...
  public InlineObject29 icon(String icon) {
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    return Objects.equals(this.name, inlineObject29.name) &&
        Objects.equals(this.displayName, inlineObject29.displayName) &&
        Objects.equals(this.description, inlineObject29.description) &&
        Objects.equals(this.icon, inlineObject29.icon);
  }
