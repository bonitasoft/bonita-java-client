...
public interface ApiProvider {
	 ...
	 * <br>
	 * <p>
	 * You won't benefit from bonita client facilities ( ie. request and payload
	 * validation, ...) and that <b>your code</b> will be <b>highly coupled to the
	 * underlying client technology</b> !
	 * <p>
	 * This access is provided to avoid people being blocked by the current limited Bonita
	 * client implementation. This may be removed in the future.
