...
class DeploymentPoliciesTest {
	...
	void development_defaults() {
		...
		assertThat(policies.getApplicationImportPolicy()).isEqualTo(ApplicationImportPolicy.REPLACE_DUPLICATES);
		assertThat(policies.getOrganizationImportPolicy()).isEqualTo(OrganizationImportPolicy.MERGE_DUPLICATES);
	...
	void production_defaults() {
		...
		assertThat(policies.getApplicationImportPolicy()).isEqualTo(ApplicationImportPolicy.REPLACE_DUPLICATES);
		assertThat(policies.getOrganizationImportPolicy()).isEqualTo(OrganizationImportPolicy.IGNORE_DUPLICATES);
		assertThat(policies.getProfileImportPolicy()).isEqualTo(ProfileImportPolicy.IGNORE_IF_ANY_EXISTS);
