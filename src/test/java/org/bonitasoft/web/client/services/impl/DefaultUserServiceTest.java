...
class DefaultUserServiceTest {
	...
	void user_should_be_found_by_name() {
		...
		assertThat(searchParams).contains(new SimpleEntry<>("p", "0")).contains(new SimpleEntry<>("c", "1"))
	...
	void can_read_profile_file() throws Exception {
		...
		// Then
		assertThat(profilesNames).hasSize(7).contains("Administrator", "HR", "HRManager", "Process manager",
				"TahitiUser", "TeamManager", "User");
	}
