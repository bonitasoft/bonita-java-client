...
/**
 * API tests for PortalAuthenticationApi
 */
public class PortalAuthenticationApiTest {

    private PortalAuthenticationApi api;

    @Before
    public void setup() {
        api = new ApiClient().createService(PortalAuthenticationApi.class);
    }
