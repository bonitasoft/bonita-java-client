...
/**
 * Model tests for ContractConstraints
 */
public class ContractConstraintsTest {
    private final ContractConstraints model = new ContractConstraints();
