...
class BonitaClientIT {
  ...
  void user_should_be_created() {
    ...
    Profile administratorProfile =
        bonitaClient.users().getProfileByName(BonitaClient.ADMIN_PROFILE_NAME);
  ...
  void process_should_be_uploaded_and_started() throws Exception {
    ...
    // When
    final ProcessInstantiationResponse startProcess =
  ...
  void should_assign_then_execute_user_task() throws Exception {
    ...
    bonitaClient
        ...
        .importProcess(
            ...
            ProcessImportPolicy.REPLACE_DUPLICATES);
    final ProcessInstantiationResponse humanTaskInstance =
        bonitaClient.processes().startProcess("standaloneOneHumanTask", "1.0");
