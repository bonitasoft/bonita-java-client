...
--
[.left]
image::Bonitasoft_Community_RGB.png[Bonitasoft,link="https://www.bonitasoft.com"]]

[.left]
image::openapi.png[OpenAPI,link="https://swagger.io/specification"]
--

[.float-group]
--
[.left]
image::https://github.com/bonitasoft/bonita-java-client/workflows/Build/badge.svg[Build Status,link="https://github.com/bonitasoft/bonita-java-client/actions?query=workflow%3ABuild"]
[.left]
image::https://img.shields.io/github/v/release/bonitasoft/bonita-java-client?color=blue&label=Release[Release,link="https://github.com/bonitasoft/bonita-java-client/releases"]
[.left]
image::https://img.shields.io/maven-central/v/org.bonitasoft.web/bonita-java-client.svg?label=Maven%20Central&color=orange[Maven Central,link="https://search.maven.org/search?q=g:%22org.bonitasoft.web%22%20AND%20a:%22bonita-java-client%22"]
[.left]
...
It is based on an https://swagger.io/specification/[OpenAPI] specification for **Bonita 7.11.2** `enterprise` edition.
...
* Cover publicly available http endpoints of Bonita Platform 7.11.2 and onwards
...
. Project homepage: https://github.com/bonitasoft/bonita-java-client/
. Repository: https://github.com/bonitasoft/bonita-java-client/
. Issue tracker: https://github.com/bonitasoft/bonita-java-client/issues. +
...
. Current Bonita REST API documentation: https://documentation.bonitasoft.com/bonita/7.11/rest-api-overview
