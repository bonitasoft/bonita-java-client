...
:bonita-short-version: 10.2
:bonita-marketing-version: 2024.3
:orga: bonitasoft
...
It is based on an https://swagger.io/specification/[OpenAPI image:openapi.png[OpenAPI,width=30px]^] specification for **Bonita {bonita-marketing-version} ({bonita-short-version})** `Enterprise` edition.
...
* Cover publicly available http endpoints of Bonita Platform {bonita-marketing-version} and onwards
...
This matrix gives you the compatibility between this library and the Bonita versions. In case you are using an older version of Bonita, refer to the corresponding tagged version of this library's documentation.
[cols="1,1"]
|===
|Bonita Java Client version |Bonita version 

|{project-version}
|{bonita-marketing-version} ({bonita-short-version}) or higher

|https://github.com/bonitasoft/bonita-java-client/tree/1.0.1[1.0.1] or 1.0.0
|2021.2 (7.13) to 2024.2 (10.1)

|https://github.com/bonitasoft/bonita-java-client/tree/0.0.10[0.0.10] or prior
|7.11 to 2021.1 (7.12)
|===
