...
------------- | ------------- | -------------
[**createApplication**](ApplicationApi.md#createApplication) | **POST** API/living/application | Create a living applications
[**deleteApplicationById**](ApplicationApi.md#deleteApplicationById) | **DELETE** API/living/application/{id} | Delete a living application by ID
[**findApplications**](ApplicationApi.md#findApplications) | **GET** API/living/application | Finds living applications
[**getApplicationById**](ApplicationApi.md#getApplicationById) | **GET** API/living/application/{id} | Finds a living application by ID
[**importApplication**](ApplicationApi.md#importApplication) | **POST** services/application/import | Import a living application
[**updateApplicationById**](ApplicationApi.md#updateApplicationById) | **PUT** API/living/application/{id} | Update a living application by ID
[**uploadApplication**](ApplicationApi.md#uploadApplication) | **POST** portal/applicationsUpload | Upload a living application
...
import org.bonitasoft.web.client.internal.api.ApplicationApi;
...
public class Example {
    public static void main(String[] args) {
        ...
        CreateApplicationRequest body = new CreateApplicationRequest(); // CreateApplicationRequest | Partial living application description
        try {
...
------------- | ------------- | ------------- | -------------
 **body** | [**CreateApplicationRequest**](CreateApplicationRequest.md)| Partial living application description |
...
public class Example {
    public static void main(String[] args) {
        ...
        try {
            apiInstance.deleteApplicationById(id);
        } catch (ApiException e) {
            System.err.println("Exception when calling ApplicationApi#deleteApplicationById");
            System.err.println("Status code: " + e.getCode());
            System.err.println("Reason: " + e.getResponseBody());
            System.err.println("Response headers: " + e.getResponseHeaders());
            e.printStackTrace();
...
> List&lt;Application&gt; findApplications(p, c, f, o, s)
...
public class Example {
    public static void main(String[] args) {
        ...
        try {
            List<Application> result = apiInstance.findApplications(p, c, f, o, s);
            System.out.println(result);
        } catch (ApiException e) {
            System.err.println("Exception when calling ApplicationApi#findApplications");
            System.err.println("Status code: " + e.getCode());
            System.err.println("Reason: " + e.getResponseBody());
            System.err.println("Response headers: " + e.getResponseHeaders());
            e.printStackTrace();
...
> importApplication(applicationsDataUpload, importPolicy)
...
public class Example {
    public static void main(String[] args) {
        ...
        ApplicationApi apiInstance = new ApplicationApi(defaultClient);
        String applicationsDataUpload = "applicationsDataUpload_example"; // String | Uploaded file
        String importPolicy = "importPolicy_example"; // String | Import policy
        try {
            apiInstance.importApplication(applicationsDataUpload, importPolicy);
        } catch (ApiException e) {
            System.err.println("Exception when calling ApplicationApi#importApplication");
            System.err.println("Status code: " + e.getCode());
            System.err.println("Reason: " + e.getResponseBody());
            System.err.println("Response headers: " + e.getResponseHeaders());
            e.printStackTrace();
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **applicationsDataUpload** | **String**| Uploaded file | [optional]
...
> Application updateApplicationById(id, inlineObject)
...
public class Example {
    public static void main(String[] args) {
        ...
        try {
            Application result = apiInstance.updateApplicationById(id, inlineObject);
            System.out.println(result);
        } catch (ApiException e) {
...
public class Example {
    public static void main(String[] args) {
        ...
        try {
            apiInstance.uploadApplication(file);
        } catch (ApiException e) {
            System.err.println("Exception when calling ApplicationApi#uploadApplication");
            System.err.println("Status code: " + e.getCode());
            System.err.println("Reason: " + e.getResponseBody());
            System.err.println("Response headers: " + e.getResponseHeaders());
            e.printStackTrace();
