# ArchivedConnectorInstanceApi

All URIs are relative to *http://localhost:8080/bonita*

Method | HTTP request | Description
------------- | ------------- | -------------
[**findArchivedConnectorInstances**](ArchivedConnectorInstanceApi.md#findArchivedConnectorInstances) | **GET** API/bpm/archivedConnectorInstance | Finds ArchivedConnectorInstances



## findArchivedConnectorInstances

> List&lt;ArchivedConnectorInstance&gt; findArchivedConnectorInstances(p, c, f, o, s)
...
import org.bonitasoft.web.client.internal.api.ArchivedConnectorInstanceApi;
...
public class Example {
    public static void main(String[] args) {
        ...
        ArchivedConnectorInstanceApi apiInstance = new ArchivedConnectorInstanceApi(defaultClient);
        ...
        try {
            List<ArchivedConnectorInstance> result = apiInstance.findArchivedConnectorInstances(p, c, f, o, s);
            System.out.println(result);
        } catch (ApiException e) {
            System.err.println("Exception when calling ArchivedConnectorInstanceApi#findArchivedConnectorInstances");
...
[**List&lt;ArchivedConnectorInstance&gt;**](ArchivedConnectorInstance.md)
