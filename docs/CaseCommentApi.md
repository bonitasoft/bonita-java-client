...
------------- | ------------- | -------------
[**createCaseComment**](CaseCommentApi.md#createCaseComment) | **POST** API/bpm/comment | Create the CaseComment
[**findCaseComments**](CaseCommentApi.md#findCaseComments) | **GET** API/bpm/comment | Finds CaseComments



## createCaseComment

> CaseComment createCaseComment(body)
...
import org.bonitasoft.web.client.internal.api.CaseCommentApi;
...
public class Example {
    public static void main(String[] args) {
        ...
        CaseCommentApi apiInstance = new CaseCommentApi(defaultClient);
        InlineObject17 body = new InlineObject17(); // InlineObject17 | 
        try {
            CaseComment result = apiInstance.createCaseComment(body);
            System.out.println(result);
        } catch (ApiException e) {
            System.err.println("Exception when calling CaseCommentApi#createCaseComment");
...
> List&lt;CaseComment&gt; findCaseComments(p, c, f, o)
...
public class Example {
    public static void main(String[] args) {
        ...
        try {
            List<CaseComment> result = apiInstance.findCaseComments(p, c, f, o);
            System.out.println(result);
        } catch (ApiException e) {
            System.err.println("Exception when calling CaseCommentApi#findCaseComments");
            System.err.println("Status code: " + e.getCode());
            System.err.println("Reason: " + e.getResponseBody());
            System.err.println("Response headers: " + e.getResponseHeaders());
            e.printStackTrace();
...
[**List&lt;CaseComment&gt;**](CaseComment.md)
