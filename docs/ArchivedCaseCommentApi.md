# ArchivedCaseCommentApi

All URIs are relative to *http://localhost:8080/bonita*

Method | HTTP request | Description
------------- | ------------- | -------------
[**findArchivedCaseComments**](ArchivedCaseCommentApi.md#findArchivedCaseComments) | **GET** API/bpm/archivedComment | Finds ArchivedCaseComments



## findArchivedCaseComments

> List&lt;ArchivedCaseComment&gt; findArchivedCaseComments(p, c, f, o, s)
...
import org.bonitasoft.web.client.internal.api.ArchivedCaseCommentApi;
...
public class Example {
    public static void main(String[] args) {
        ...
        ArchivedCaseCommentApi apiInstance = new ArchivedCaseCommentApi(defaultClient);
        ...
        try {
            List<ArchivedCaseComment> result = apiInstance.findArchivedCaseComments(p, c, f, o, s);
            System.out.println(result);
        } catch (ApiException e) {
            System.err.println("Exception when calling ArchivedCaseCommentApi#findArchivedCaseComments");
...
[**List&lt;ArchivedCaseComment&gt;**](ArchivedCaseComment.md)
