...
------------- | ------------- | -------------
[**createCase**](CaseApi.md#createCase) | **POST** API/bpm/case | Create the Case
[**deleteCaseById**](CaseApi.md#deleteCaseById) | **DELETE** API/bpm/case/{id} | Delete the Case by ID
[**deleteCaseByIds**](CaseApi.md#deleteCaseByIds) | **DELETE** API/bpm/case | Delete the Case by batch
[**findCases**](CaseApi.md#findCases) | **GET** API/bpm/case | Finds Cases
[**getCaseById**](CaseApi.md#getCaseById) | **GET** API/bpm/case/{id} | Finds the Case by ID
[**getContextByCaseId**](CaseApi.md#getContextByCaseId) | **GET** API/bpm/case/{id}/context | Finds the Context by Case ID



## createCase

> ModelCase createCase(body)
...
import org.bonitasoft.web.client.internal.api.CaseApi;
...
public class Example {
    public static void main(String[] args) {
        ...
        try {
            ModelCase result = apiInstance.createCase(body);
...
public class Example {
    public static void main(String[] args) {
        ...
        CaseApi apiInstance = new CaseApi(defaultClient);
        String id = "id_example"; // String | ID of the Case to delete
        try {
            apiInstance.deleteCaseById(id);
        } catch (ApiException e) {
            System.err.println("Exception when calling CaseApi#deleteCaseById");
            System.err.println("Status code: " + e.getCode());
            System.err.println("Reason: " + e.getResponseBody());
            System.err.println("Response headers: " + e.getResponseHeaders());
            e.printStackTrace();
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **id** | **String**| ID of the Case to delete |
...
public class Example {
    public static void main(String[] args) {
        ...
        try {
            apiInstance.deleteCaseByIds(requestBody);
        } catch (ApiException e) {
            System.err.println("Exception when calling CaseApi#deleteCaseByIds");
            System.err.println("Status code: " + e.getCode());
            System.err.println("Reason: " + e.getResponseBody());
            System.err.println("Response headers: " + e.getResponseHeaders());
            e.printStackTrace();
...
> List&lt;ModelCase&gt; findCases(p, c, f, o)
...
public class Example {
    public static void main(String[] args) {
        ...
        try {
            List<ModelCase> result = apiInstance.findCases(p, c, f, o);
            System.out.println(result);
        } catch (ApiException e) {
            System.err.println("Exception when calling CaseApi#findCases");
            System.err.println("Status code: " + e.getCode());
            System.err.println("Reason: " + e.getResponseBody());
            System.err.println("Response headers: " + e.getResponseHeaders());
            e.printStackTrace();
...
public class Example {
    public static void main(String[] args) {
        ...
        CaseApi apiInstance = new CaseApi(defaultClient);
        String id = "id_example"; // String | ID of the Case to return
        String n = "n_example"; // String | Count of related resources
        try {
            ModelCase result = apiInstance.getCaseById(id, n);
            System.out.println(result);
        } catch (ApiException e) {
            System.err.println("Exception when calling CaseApi#getCaseById");
            System.err.println("Status code: " + e.getCode());
            System.err.println("Reason: " + e.getResponseBody());
            System.err.println("Response headers: " + e.getResponseHeaders());
            e.printStackTrace();
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **id** | **String**| ID of the Case to return |
 **n** | **String**| Count of related resources | [optional] [enum: activeFlowNodes, failedFlowNodes]
...
> Map&lt;String, Object&gt; getContextByCaseId(id)
...
public class Example {
    public static void main(String[] args) {
        ...
        CaseApi apiInstance = new CaseApi(defaultClient);
        String id = "id_example"; // String | ID of the Case that has the Context to return
        try {
            Map<String, Object> result = apiInstance.getContextByCaseId(id);
            System.out.println(result);
        } catch (ApiException e) {
            System.err.println("Exception when calling CaseApi#getContextByCaseId");
            System.err.println("Status code: " + e.getCode());
            System.err.println("Reason: " + e.getResponseBody());
            System.err.println("Response headers: " + e.getResponseHeaders());
            e.printStackTrace();
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **id** | **String**| ID of the Case that has the Context to return |
