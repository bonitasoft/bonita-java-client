...
------------- | ------------- | -------------
[**createRole**](RoleApi.md#createRole) | **POST** API/identity/role | Create the Role
[**deleteRoleById**](RoleApi.md#deleteRoleById) | **DELETE** API/identity/role/{id} | Delete the Role by ID
[**findRoles**](RoleApi.md#findRoles) | **GET** API/identity/role | Finds Roles
[**getRoleById**](RoleApi.md#getRoleById) | **GET** API/identity/role/{id} | Finds the Role by ID
[**updateRoleById**](RoleApi.md#updateRoleById) | **PUT** API/identity/role/{id} | Update the Role by ID
...
import org.bonitasoft.web.client.internal.api.RoleApi;
...
public class Example {
    public static void main(String[] args) {
        ...
        InlineObject29 body = new InlineObject29(); // InlineObject29 | 
        try {
...
public class Example {
    public static void main(String[] args) {
        ...
        RoleApi apiInstance = new RoleApi(defaultClient);
        String id = "id_example"; // String | ID of the Role to delete
        try {
            apiInstance.deleteRoleById(id);
        } catch (ApiException e) {
            System.err.println("Exception when calling RoleApi#deleteRoleById");
            System.err.println("Status code: " + e.getCode());
            System.err.println("Reason: " + e.getResponseBody());
            System.err.println("Response headers: " + e.getResponseHeaders());
            e.printStackTrace();
...
public class Example {
    public static void main(String[] args) {
        ...
        try {
            List<Role> result = apiInstance.findRoles(p, c, f, o, s);
            System.out.println(result);
        } catch (ApiException e) {
            System.err.println("Exception when calling RoleApi#findRoles");
            System.err.println("Status code: " + e.getCode());
            System.err.println("Reason: " + e.getResponseBody());
            System.err.println("Response headers: " + e.getResponseHeaders());
            e.printStackTrace();
...
public class Example {
    public static void main(String[] args) {
        ...
        RoleApi apiInstance = new RoleApi(defaultClient);
        String id = "id_example"; // String | ID of the Role to return
        try {
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **id** | **String**| ID of the Role to return |
...
> updateRoleById(id, inlineObject30)
...
public class Example {
    public static void main(String[] args) {
        ...
        try {
            apiInstance.updateRoleById(id, inlineObject30);
        } catch (ApiException e) {
            System.err.println("Exception when calling RoleApi#updateRoleById");
            System.err.println("Status code: " + e.getCode());
            System.err.println("Reason: " + e.getResponseBody());
            System.err.println("Response headers: " + e.getResponseHeaders());
            e.printStackTrace();
