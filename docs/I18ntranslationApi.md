...
------------- | ------------- | -------------
[**findI18ntranslations**](I18ntranslationApi.md#findI18ntranslations) | **GET** API/system/i18ntranslation | Finds I18ntranslations



## findI18ntranslations

> List&lt;Map&lt;String, String&gt;&gt; findI18ntranslations(p, c, f)
...
import org.bonitasoft.web.client.internal.api.I18ntranslationApi;
...
public class Example {
    public static void main(String[] args) {
        ...
        I18ntranslationApi apiInstance = new I18ntranslationApi(defaultClient);
        ...
        try {
            List<Map<String, String>> result = apiInstance.findI18ntranslations(p, c, f);
            System.out.println(result);
        } catch (ApiException e) {
            System.err.println("Exception when calling I18ntranslationApi#findI18ntranslations");
