...
------------- | ------------- | -------------
[**createApplicationPage**](ApplicationPageApi.md#createApplicationPage) | **POST** API/living/application-page | Create an application page
[**deleteApplicationPageById**](ApplicationPageApi.md#deleteApplicationPageById) | **DELETE** API/living/application-page/{id} | Delete an application page by ID
[**findApplicationPages**](ApplicationPageApi.md#findApplicationPages) | **GET** API/living/application-page | Finds application pages
[**getApplicationPageById**](ApplicationPageApi.md#getApplicationPageById) | **GET** API/living/application-page/{id} | Finds an application page by ID



## createApplicationPage

> ApplicationPage createApplicationPage(body)
...
import org.bonitasoft.web.client.internal.api.ApplicationPageApi;
...
public class Example {
    public static void main(String[] args) {
        ...
        ApplicationPageApi apiInstance = new ApplicationPageApi(defaultClient);
        InlineObject4 body = new InlineObject4(); // InlineObject4 | 
        try {
            ApplicationPage result = apiInstance.createApplicationPage(body);
            System.out.println(result);
        } catch (ApiException e) {
            System.err.println("Exception when calling ApplicationPageApi#createApplicationPage");
...
[**ApplicationPage**](ApplicationPage.md)
...
public class Example {
    public static void main(String[] args) {
        ...
        ApplicationPageApi apiInstance = new ApplicationPageApi(defaultClient);
        String id = "id_example"; // String | ID of application page to delete
        try {
            apiInstance.deleteApplicationPageById(id);
        } catch (ApiException e) {
            System.err.println("Exception when calling ApplicationPageApi#deleteApplicationPageById");
            System.err.println("Status code: " + e.getCode());
            System.err.println("Reason: " + e.getResponseBody());
            System.err.println("Response headers: " + e.getResponseHeaders());
            e.printStackTrace();
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **id** | **String**| ID of application page to delete |
...
## findApplicationPages

> List&lt;ApplicationPage&gt; findApplicationPages(p, c, f, o, s)
...
public class Example {
    public static void main(String[] args) {
        ...
        try {
            List<ApplicationPage> result = apiInstance.findApplicationPages(p, c, f, o, s);
            System.out.println(result);
        } catch (ApiException e) {
            System.err.println("Exception when calling ApplicationPageApi#findApplicationPages");
            System.err.println("Status code: " + e.getCode());
            System.err.println("Reason: " + e.getResponseBody());
            System.err.println("Response headers: " + e.getResponseHeaders());
            e.printStackTrace();
...
[**List&lt;ApplicationPage&gt;**](ApplicationPage.md)
...
> ApplicationPage getApplicationPageById(id)
...
public class Example {
    public static void main(String[] args) {
        ...
        ApplicationPageApi apiInstance = new ApplicationPageApi(defaultClient);
        String id = "id_example"; // String | ID of application page to return
        try {
            ApplicationPage result = apiInstance.getApplicationPageById(id);
            System.out.println(result);
        } catch (ApiException e) {
            System.err.println("Exception when calling ApplicationPageApi#getApplicationPageById");
            System.err.println("Status code: " + e.getCode());
            System.err.println("Reason: " + e.getResponseBody());
            System.err.println("Response headers: " + e.getResponseHeaders());
            e.printStackTrace();
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **id** | **String**| ID of application page to return |
