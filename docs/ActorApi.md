...
------------- | ------------- | -------------
[**findActors**](ActorApi.md#findActors) | **GET** API/bpm/actor | Finds Actors
[**getActorById**](ActorApi.md#getActorById) | **GET** API/bpm/actor/{id} | Finds the Actor by ID
[**updateActorById**](ActorApi.md#updateActorById) | **PUT** API/bpm/actor/{id} | Update the Actor by ID



## findActors

> List&lt;Actor&gt; findActors(p, c, f, o)
...
import org.bonitasoft.web.client.internal.api.ActorApi;
...
public class Example {
    public static void main(String[] args) {
        ...
        ActorApi apiInstance = new ActorApi(defaultClient);
        ...
        try {
            List<Actor> result = apiInstance.findActors(p, c, f, o);
            System.out.println(result);
        } catch (ApiException e) {
            System.err.println("Exception when calling ActorApi#findActors");
...
public class Example {
    public static void main(String[] args) {
        ...
        ActorApi apiInstance = new ActorApi(defaultClient);
        String id = "id_example"; // String | ID of the Actor to return
        try {
            Actor result = apiInstance.getActorById(id);
            System.out.println(result);
        } catch (ApiException e) {
            System.err.println("Exception when calling ActorApi#getActorById");
            System.err.println("Status code: " + e.getCode());
            System.err.println("Reason: " + e.getResponseBody());
            System.err.println("Response headers: " + e.getResponseHeaders());
            e.printStackTrace();
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **id** | **String**| ID of the Actor to return |
...
> updateActorById(id, inlineObject15)
...
public class Example {
    public static void main(String[] args) {
        ...
        try {
            apiInstance.updateActorById(id, inlineObject15);
        } catch (ApiException e) {
            System.err.println("Exception when calling ActorApi#updateActorById");
            System.err.println("Status code: " + e.getCode());
            System.err.println("Reason: " + e.getResponseBody());
            System.err.println("Response headers: " + e.getResponseHeaders());
            e.printStackTrace();
