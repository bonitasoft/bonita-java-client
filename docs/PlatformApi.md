...
------------- | ------------- | -------------
[**getPlatformById**](PlatformApi.md#getPlatformById) | **GET** API/platform/platform/unusedid | Finds the Platform by ID
[**platformLogin**](PlatformApi.md#platformLogin) | **POST** platformloginservice | Platform Login
[**platformLogout**](PlatformApi.md#platformLogout) | **POST** platformlogoutservice | Platform Logout
[**updatePlatformById**](PlatformApi.md#updatePlatformById) | **PUT** API/platform/platform/unusedid | Update the Platform by ID
...
import org.bonitasoft.web.client.internal.api.PlatformApi;
...
public class Example {
    public static void main(String[] args) {
        ...
        try {
            Platform result = apiInstance.getPlatformById();
            System.out.println(result);
        } catch (ApiException e) {
            System.err.println("Exception when calling PlatformApi#getPlatformById");
...
public class Example {
    public static void main(String[] args) {
        ...
        try {
            ...
            System.err.println("Exception when calling PlatformApi#platformLogin");
            System.err.println("Status code: " + e.getCode());
            System.err.println("Reason: " + e.getResponseBody());
            System.err.println("Response headers: " + e.getResponseHeaders());
            e.printStackTrace();
...
public class Example {
    public static void main(String[] args) {
        ...
        try {
            ...
            System.err.println("Exception when calling PlatformApi#platformLogout");
            System.err.println("Status code: " + e.getCode());
            System.err.println("Reason: " + e.getResponseBody());
            System.err.println("Response headers: " + e.getResponseHeaders());
            e.printStackTrace();
...
> updatePlatformById(inlineObject34)
...
public class Example {
    public static void main(String[] args) {
        ...
        try {
            apiInstance.updatePlatformById(inlineObject34);
        } catch (ApiException e) {
            System.err.println("Exception when calling PlatformApi#updatePlatformById");
            System.err.println("Status code: " + e.getCode());
            System.err.println("Reason: " + e.getResponseBody());
            System.err.println("Response headers: " + e.getResponseHeaders());
            e.printStackTrace();
