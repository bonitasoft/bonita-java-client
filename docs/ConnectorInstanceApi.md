...
------------- | ------------- | -------------
[**findConnectorInstances**](ConnectorInstanceApi.md#findConnectorInstances) | **GET** API/bpm/connectorInstance | Finds ConnectorInstances



## findConnectorInstances

> List&lt;ConnectorInstance&gt; findConnectorInstances(p, c, f, o, s)
...
import org.bonitasoft.web.client.internal.api.ConnectorInstanceApi;
...
public class Example {
    public static void main(String[] args) {
        ...
        ConnectorInstanceApi apiInstance = new ConnectorInstanceApi(defaultClient);
        ...
        try {
            List<ConnectorInstance> result = apiInstance.findConnectorInstances(p, c, f, o, s);
            System.out.println(result);
        } catch (ApiException e) {
            System.err.println("Exception when calling ConnectorInstanceApi#findConnectorInstances");
