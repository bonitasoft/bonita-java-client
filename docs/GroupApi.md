...
------------- | ------------- | -------------
[**createGroup**](GroupApi.md#createGroup) | **POST** API/identity/group | Create the Group
[**deleteGroupById**](GroupApi.md#deleteGroupById) | **DELETE** API/identity/group/{id} | Delete the Group by ID
[**findGroups**](GroupApi.md#findGroups) | **GET** API/identity/group | Finds Groups
[**getGroupById**](GroupApi.md#getGroupById) | **GET** API/identity/group/{id} | Finds the Group by ID
[**updateGroupById**](GroupApi.md#updateGroupById) | **PUT** API/identity/group/{id} | Update the Group by ID
...
import org.bonitasoft.web.client.internal.api.GroupApi;
...
public class Example {
    public static void main(String[] args) {
        ...
        InlineObject26 body = new InlineObject26(); // InlineObject26 | 
        try {
...
public class Example {
    public static void main(String[] args) {
        ...
        try {
            apiInstance.deleteGroupById(id);
        } catch (ApiException e) {
            System.err.println("Exception when calling GroupApi#deleteGroupById");
            System.err.println("Status code: " + e.getCode());
            System.err.println("Reason: " + e.getResponseBody());
            System.err.println("Response headers: " + e.getResponseHeaders());
            e.printStackTrace();
...
public class Example {
    public static void main(String[] args) {
        ...
        try {
            List<Group> result = apiInstance.findGroups(p, c, f, o);
            System.out.println(result);
        } catch (ApiException e) {
            System.err.println("Exception when calling GroupApi#findGroups");
            System.err.println("Status code: " + e.getCode());
            System.err.println("Reason: " + e.getResponseBody());
            System.err.println("Response headers: " + e.getResponseHeaders());
            e.printStackTrace();
...
public class Example {
    public static void main(String[] args) {
        ...
        GroupApi apiInstance = new GroupApi(defaultClient);
        String id = "id_example"; // String | ID of the Group to return
        try {
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **id** | **String**| ID of the Group to return |
...
> updateGroupById(id, inlineObject27)
...
public class Example {
    public static void main(String[] args) {
        ...
        try {
            apiInstance.updateGroupById(id, inlineObject27);
        } catch (ApiException e) {
            System.err.println("Exception when calling GroupApi#updateGroupById");
            System.err.println("Status code: " + e.getCode());
            System.err.println("Reason: " + e.getResponseBody());
            System.err.println("Response headers: " + e.getResponseHeaders());
            e.printStackTrace();
