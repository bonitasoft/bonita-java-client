...
------------- | ------------- | -------------
[**getSystemTenant**](SystemTenantApi.md#getSystemTenant) | **GET** API/system/tenant/unusedid | Get the current Tenant
[**updateSystemTenant**](SystemTenantApi.md#updateSystemTenant) | **PUT** API/system/tenant/unusedid | Update the current Tenant
...
import org.bonitasoft.web.client.internal.api.SystemTenantApi;
...
public class Example {
    public static void main(String[] args) {
        ...
        SystemTenantApi apiInstance = new SystemTenantApi(defaultClient);
        try {
            SystemTenant result = apiInstance.getSystemTenant();
            System.out.println(result);
        } catch (ApiException e) {
            System.err.println("Exception when calling SystemTenantApi#getSystemTenant");
...
> updateSystemTenant(inlineObject48)
...
public class Example {
    public static void main(String[] args) {
        ...
        SystemTenantApi apiInstance = new SystemTenantApi(defaultClient);
        InlineObject48 inlineObject48 = new InlineObject48(); // InlineObject48 | 
        try {
            apiInstance.updateSystemTenant(inlineObject48);
        } catch (ApiException e) {
            System.err.println("Exception when calling SystemTenantApi#updateSystemTenant");
            System.err.println("Status code: " + e.getCode());
            System.err.println("Reason: " + e.getResponseBody());
            System.err.println("Response headers: " + e.getResponseHeaders());
            e.printStackTrace();
