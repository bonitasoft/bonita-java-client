...
------------- | ------------- | -------------
[**createTenant**](TenantApi.md#createTenant) | **POST** API/platform/tenant | Create the Tenant
[**deleteTenantById**](TenantApi.md#deleteTenantById) | **DELETE** API/platform/tenant/{id} | Delete the Tenant by ID
[**findTenants**](TenantApi.md#findTenants) | **GET** API/platform/tenant | Finds Tenants
[**getTenantById**](TenantApi.md#getTenantById) | **GET** API/platform/tenant/{id} | Finds the Tenant by ID
[**updateTenantById**](TenantApi.md#updateTenantById) | **PUT** API/platform/tenant/{id} | Update the Tenant by ID
...
import org.bonitasoft.web.client.internal.api.TenantApi;
...
public class Example {
    public static void main(String[] args) {
        ...
        InlineObject35 body = new InlineObject35(); // InlineObject35 | 
        try {
...
public class Example {
    public static void main(String[] args) {
        ...
        try {
            ...
            System.err.println("Exception when calling TenantApi#deleteTenantById");
            System.err.println("Status code: " + e.getCode());
            System.err.println("Reason: " + e.getResponseBody());
            System.err.println("Response headers: " + e.getResponseHeaders());
            e.printStackTrace();
...
> List&lt;Tenant&gt; findTenants(p, c, f, o, s)
...
public class Example {
    public static void main(String[] args) {
        ...
        try {
            List<Tenant> result = apiInstance.findTenants(p, c, f, o, s);
            System.out.println(result);
        } catch (ApiException e) {
            System.err.println("Exception when calling TenantApi#findTenants");
            System.err.println("Status code: " + e.getCode());
            System.err.println("Reason: " + e.getResponseBody());
            System.err.println("Response headers: " + e.getResponseHeaders());
            e.printStackTrace();
...
public class Example {
    public static void main(String[] args) {
        ...
        TenantApi apiInstance = new TenantApi(defaultClient);
        String id = "id_example"; // String | ID of the Tenant to return
        try {
            Tenant result = apiInstance.getTenantById(id);
            System.out.println(result);
        } catch (ApiException e) {
            System.err.println("Exception when calling TenantApi#getTenantById");
            System.err.println("Status code: " + e.getCode());
            System.err.println("Reason: " + e.getResponseBody());
            System.err.println("Response headers: " + e.getResponseHeaders());
            e.printStackTrace();
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **id** | **String**| ID of the Tenant to return |
...
> updateTenantById(id, inlineObject36)
...
public class Example {
    public static void main(String[] args) {
        ...
        try {
            apiInstance.updateTenantById(id, inlineObject36);
        } catch (ApiException e) {
            System.err.println("Exception when calling TenantApi#updateTenantById");
            System.err.println("Status code: " + e.getCode());
            System.err.println("Reason: " + e.getResponseBody());
            System.err.println("Response headers: " + e.getResponseHeaders());
            e.printStackTrace();
