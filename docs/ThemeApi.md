...
------------- | ------------- | -------------
[**createTheme**](ThemeApi.md#createTheme) | **POST** API/portal/theme | Create the Theme
[**updateTheme**](ThemeApi.md#updateTheme) | **PUT** API/portal/theme/unusedId | Update the Theme by ID
...
import org.bonitasoft.web.client.internal.api.ThemeApi;
...
public class Example {
    public static void main(String[] args) {
        ...
        InlineObject46 body = new InlineObject46(); // InlineObject46 | 
        try {
            apiInstance.createTheme(body);
        } catch (ApiException e) {
            System.err.println("Exception when calling ThemeApi#createTheme");
...
public class Example {
    public static void main(String[] args) {
        ...
        try {
            apiInstance.updateTheme(inlineObject47);
        } catch (ApiException e) {
            System.err.println("Exception when calling ThemeApi#updateTheme");
            System.err.println("Status code: " + e.getCode());
            System.err.println("Reason: " + e.getResponseBody());
            System.err.println("Response headers: " + e.getResponseHeaders());
            e.printStackTrace();
