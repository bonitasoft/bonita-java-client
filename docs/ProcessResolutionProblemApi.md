...
------------- | ------------- | -------------
[**findProcessResolutionProblems**](ProcessResolutionProblemApi.md#findProcessResolutionProblems) | **GET** API/bpm/processResolutionProblem | Finds ProcessResolutionProblems



## findProcessResolutionProblems

> List&lt;ProcessResolutionProblem&gt; findProcessResolutionProblems(p, c, f, o, s)
...
import org.bonitasoft.web.client.internal.api.ProcessResolutionProblemApi;
...
public class Example {
    public static void main(String[] args) {
        ...
        ProcessResolutionProblemApi apiInstance = new ProcessResolutionProblemApi(defaultClient);
        ...
        try {
            List<ProcessResolutionProblem> result = apiInstance.findProcessResolutionProblems(p, c, f, o, s);
            System.out.println(result);
        } catch (ApiException e) {
            System.err.println("Exception when calling ProcessResolutionProblemApi#findProcessResolutionProblems");
...
[**List&lt;ProcessResolutionProblem&gt;**](ProcessResolutionProblem.md)
